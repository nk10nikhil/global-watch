...
import { backtestStock } from "../server/globalwatch/market/v1/backtest-stock.ts";
import { listStoredStockBacktests } from "../server/globalwatch/market/v1/list-stored-stock-backtests.ts";
import { MarketServiceClient } from "../src/generated/client/globalwatch/market/v1/service_client.ts";
