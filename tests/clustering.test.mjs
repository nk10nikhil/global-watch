...
describe("_clustering.mjs", () => {
  describe("clusterItems", () => {
    ...
    it("keeps different titles as separate clusters", () => {
      const items = [
        ...
        {
          title: "Stock market rallies on tech earnings report",
          source: "CNBC",
          link: "http://b",
        },
      ];
    ...
    it("preserves primaryTitle from highest-tier source", () => {
      const items = [
        {
          title: "Iran strikes Syria overnight",
          source: "Blog",
          link: "http://b",
          tier: 5,
        },
  ...
  describe("scoreImportance", () => {
    ...
    it("gives combo bonus for flashpoint + violence", () => {
      ...
      const violenceOnly = {
        primaryTitle: "Crackdown killed dozens in protests",
        sourceCount: 1,
      };
      assert.ok(
        scoreImportance(flashpointViolence) > scoreImportance(violenceOnly),
      );
    });

    it("demotes business context", () => {
      const pure = {
        primaryTitle: "Strike hits military targets",
        sourceCount: 1,
      };
      const business = {
    ...
    it("adds alert bonus", () => {
      const noAlert = {
        primaryTitle: "Earthquake hits region",
        sourceCount: 1,
        isAlert: false,
      };
      const alert = {
