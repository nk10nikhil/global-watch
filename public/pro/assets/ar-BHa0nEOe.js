const e = {
  ...
  r = {
    ...
    signalWord: "إشارة",
    valueProps:
      "أبحاث أسهم مدعومة بالذكاء الاصطناعي، وتحليل جيوسياسي، واستخبارات اقتصادية كلية — مترابطة في الوقت الفعلي.",
  ...
  t = {
    ...
    description:
      "كرة أرضية ثلاثية الأبعاد WebGL · أكثر من 45 طبقة خريطة تفاعلية · بيانات جغرافية سياسية ومالية وطاقة وبنية تحتية فورية",
  },
  a = {
    ...
    quote:
      "أصبح تحليل الأخبار صعبًا حقًا. إيران، قرارات ترامب، الأسواق المالية، المعادن الحرجة، توترات تتراكم من كل اتجاه في آنٍ واحد. احتجت إلى شيء يُظهر لي كيف ترتبط هذه الأحداث ببعضها في الوقت الفعلي.",
  ...
  s = {
    ...
    subtitle:
      "22 نطاق خدمة يتم استيعابها في آنٍ واحد. كل شيء موحّد ومحدّد جغرافيًا ومعروض على كرة أرضية WebGL بآلاف العلامات.",
    ...
    gdeltDesc:
      "أكثر من 435 تغذية RSS، أحداث GDELT مصنّفة بالذكاء الاصطناعي، بث مباشر",
  ...
  n = {
    ...
    subtitle:
      "لوحة المعلومات المجانية تُريك العالم. Pro يخبرك بما يعنيه — ويضمن ألا يفوتك ما يهم.",
    nearRealTime: "بيانات شبه فورية",
    nearRealTimeDesc:
      "التحديث تسارع من 5-15 دقيقة إلى أقل من 60 ثانية. خط أولوية لتنبيهاتك.",
    soWhat: 'تحليل "ماذا يعني هذا؟"',
    soWhatDesc:
      "سلاسل التأثير، التعرّف على الأنماط، كشف التقارب، والربط بين الأسواق والجغرافيا السياسية.",
    orbitalSurveillance: "تحليل المراقبة المدارية",
    orbitalSurveillanceDesc:
      "توقعات عبور الأقمار، تحليل تكرار الزيارات، وتنبيهات نوافذ التصوير. اعرف متى تراقب الأقمار الاصطناعية مناطق اهتمامك.",
    morningBriefs: "ملخصات صباحية وتنبيهات عاجلة",
    morningBriefsDesc:
      "تطورات الليلة السابقة مُلخّصة بالذكاء الاصطناعي ومرتّبة حسب اهتماماتك. الأحداث العاجلة تُدفع في الوقت الفعلي.",
    alerting: "تنبيهات قابلة للتخصيص",
    alertingDesc:
      "ضع قواعد لتغيّرات CII، أحداث التقارب، القرب من مواقع محفوظة، ومحفّزات ارتباط السوق.",
    oneKey: "22 خدمة، مفتاح واحد",
    oneKeyDesc:
      "ACLED، UCDP، Finnhub، FRED، NASA FIRMS، AISStream، OpenSky، والمزيد — الكل مفعّل، بدون تسجيلات منفصلة.",
  ...
  l = {
    ...
    critical: "حرج",
    criticalText:
      "تشويش GPS في 3 مناطق بلطيقية. النمط يتطابق مع توقيعات تعطيل بنية تحتية سابقة. كابل NordBalt + Balticconnector في المنطقة المتأثرة.",
    elevated: "مرتفع",
    elevatedText:
      "CII باكستان 67→74. 12 حدث احتجاج جديد (لاهور، كراتشي، إسلام أباد). آخر ارتفاع مماثل سبق الأزمة السياسية في 2024.",
    watch: "مراقبة",
    watchText:
      "برنت +2.3% بسبب شذوذ AIS في هرمز. 4 سفن مظلمة في 6 ساعات. تمرين IRGC أُعلن الأسبوع المقبل.",
  },
  c = {
    apiTier: "فئة API",
    title: "استخبارات برمجية",
    subtitle:
      "للمطوّرين والمحلّلين والفرق التي تبني على بيانات World Monitor. منفصلة عن Pro — استخدم كليهما أو أيًا منهما.",
    ...
    feedData:
      "غذِّ لوحاتك بالبيانات، أتمت التنبيهات عبر Zapier/n8n/Make، وابنِ نماذج تقييم مخصّصة على بيانات CII/المخاطر.",
  },
  d = {
    enterpriseTier: "فئة المؤسسات",
    title: "بنية تحتية استخباراتية",
    subtitle:
      "للحكومات والمؤسسات ومكاتب التداول والمنظمات التي تحتاج المنصة الكاملة بأقصى درجات الأمان ووكلاء الذكاء الاصطناعي وعمق البيانات.",
    security: "أمان بمستوى حكومي",
    securityDesc:
      "نشر معزول، Docker داخلي، مستأجر سحابي مخصّص، مسار SOC 2 Type II، SSO/MFA، وسجل تدقيق كامل.",
    aiAgents: "وكلاء ذكاء اصطناعي و MCP",
    aiAgentsDesc:
      "وكلاء استخبارات مستقلّون مع شخصيات مستثمرين. اربط World Monitor كأداة بـ Claude أو GPT أو نماذج LLM مخصّصة عبر MCP.",
    dataLayers: "طبقات بيانات موسّعة",
    dataLayersDesc:
      "عشرات الآلاف من أصول البنية التحتية مرسومة عالميًا. تكامل صور الأقمار الاصطناعية مع كشف التغيير و SAR.",
    connectors: "أكثر من 100 موصّل بيانات",
    connectorsDesc:
      "PostgreSQL، Snowflake، Splunk، Sentinel، Jira، Slack، Teams، والمزيد. تصدير إلى PDF، PowerPoint، CSV، GeoJSON.",
    whiteLabel: "علامة بيضاء وقابل للتضمين",
    whiteLabelDesc:
      "علامتك التجارية، نطاقك، تطبيقك. لوحات iframe قابلة للتضمين لجدران SOC وقاعات التداول.",
    financial: "استخبارات مالية",
    financialDesc:
      "تقويم الأرباح، بيانات شبكة الطاقة، تتبّع سلع محسّن مع استدلال الشحنات، فحص العقوبات مع ارتباط AIS.",
    commodity: "تداول السلع",
    commodityDesc:
      "تتبّع السفن + استدلال الشحنات + رسم سلسلة التوريد. اعرف قبل أن يتحرّك السوق.",
    government: "الحكومات والمؤسسات",
    governmentDesc:
      "معزول، وكلاء ذكاء اصطناعي، وعي ظرفي كامل، MCP. لا بيانات تغادر شبكتك.",
    risk: "استشارات المخاطر",
    riskDesc:
      "محاكاة سيناريوهات، شخصيات مستثمرين، تقارير PDF/PowerPoint ذات علامة تجارية عند الطلب.",
    soc: "SOCs و CERT",
    socDesc:
      "طبقة تهديدات سيبرانية، تكامل SIEM، مراقبة شذوذات BGP، تغذيات برامج الفدية.",
  ...
  p = {
    ...
    telegram: "Telegram",
    shareText:
      "انضممت للتو إلى قائمة انتظار World Monitor Pro — استخبارات عالمية فورية مدعومة بالذكاء الاصطناعي. انضم إليّ:",
