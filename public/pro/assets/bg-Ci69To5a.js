const e = {
  ...
  r = {
    ...
    signalWord: "Сигнал",
    valueProps:
      "Проучване на акции с AI, геополитически анализ и макроикономическо разузнаване — корелирани в реално време.",
  ...
  i = { asFeaturedIn: "Както беше представено в" },
  o = {
    ...
    description:
      "3D WebGL глобус · 45+ интерактивни картни слоя · Геополитически, пазарни, енергийни и инфраструктурни данни в реално време",
  },
  t = {
    ...
    quote:
      "Новините станаха наистина трудни за анализиране. Иран, решенията на Тръмп, финансови пазари, критични минерали, напрежения, натрупващи се от всички посоки едновременно. Имах нужда от нещо, което да ми покаже как тези събития се свързват помежду си в реално време.",
  ...
  a = {
    ...
    subtitle:
      "22 служебни домена, обработвани едновременно. Всичко нормализирано, геолокализирано и визуализирано на WebGL глобус с хиляди маркери.",
    geopolitical: "Геополитически събития",
    geopoliticalDesc:
      "ACLED и UCDP събития с оценка на ескалация и анализ на тенденции",
    ...
    maritimeDesc:
      "Движение на кораби, засичане на плавателни съдове, пристанищна и търговска дейност",
    fire: "Сателитно засичане на пожари",
    fireDesc:
      "Данни от NASA FIRMS за пожари и горещи точки в близко до реално време",
    cables: "Подводни кабели",
    cablesDesc: "Маршрути на подводни кабели и кацащи станции",
    internet: "Интернет и GPS",
    internetDesc:
      "Засичане на прекъсвания, BGP аномалии, зони на GPS заглушаване",
    ...
    gdeltDesc:
      "435+ RSS потоци, оценени от AI GDELT събития, предавания на живо",
    ...
    seismologyDesc:
      "USGS земетресения, вулканична дейност, тежки метеорологични условия",
  },
  s = {
    free: "Безплатно",
  ...
  n = {
    ...
    subtitle:
      "Безплатното табло ви показва света. Pro ви казва какво означава — и гарантира, че никога не пропускате важното.",
    nearRealTime: "Данни в близко до реално време",
    nearRealTimeDesc:
      "Обновяване, ускорено от 5-15 мин до под 60 секунди. Приоритетен pipeline за вашите сигнали.",
    soWhat: 'Анализ „И какво от това?"',
    soWhatDesc:
      "Вериги на въздействие, разпознаване на модели, засичане на конвергенция и пазарно-геополитическа корелация.",
    orbitalSurveillance: "Анализ на орбитално наблюдение",
    orbitalSurveillanceDesc:
      "Прогнози за преминаване, анализ на честотата на ревизии и сигнали за прозорци за заснемане. Знайте кога разузнавателни сателити наблюдават вашите зони.",
    morningBriefs: "Сутрешни брифинги и светкавични сигнали",
    morningBriefsDesc:
      "Нощни развития, синтезирани от AI, ранжирани по вашите фокусни области. Критични събития, изпращани в реално време.",
    alerting: "Конфигурируеми сигнали",
    alertingDesc:
      "Задайте правила за CII делти, конвергентни събития, близост до запазени локации и задействащи фактори за пазарна корелация.",
    oneKey: "22 услуги, 1 ключ",
    oneKeyDesc:
      "ACLED, UCDP, Finnhub, FRED, NASA FIRMS, AISStream, OpenSky и още — всичко активно, без отделни регистрации.",
  ...
  l = {
    ...
    critical: "Критично",
    criticalText:
      "GPS заглушаване в 3 балтийски зони. Моделът съвпада с предишни сигнатури на инфраструктурно нарушение. Кабел NordBalt + Balticconnector в засегнатата зона.",
    elevated: "Повишено",
    elevatedText:
      "Пакистан CII 67→74. 12 нови протестни събития (Лахор, Карачи, Исламабад). Последният сравним скок предхождаше политическата криза от 2024 г.",
    watch: "Наблюдение",
    watchText:
      "Brent +2,3% при AIS аномалия в Хормуз. 4 тъмни кораба за 6 часа. Учение на IRGC обявено за следващата седмица.",
  },
  c = {
    apiTier: "API TIER",
    title: "Програмно разузнаване",
    subtitle:
      "За разработчици, анализатори и екипи, изграждащи върху данните на World Monitor. Отделно от Pro — използвайте и двете или което и да е.",
    ...
    feedData:
      "Захранвайте данни в таблата си, автоматизирайте сигнали чрез Zapier/n8n/Make, изграждайте персонализирани модели за оценка на CII/рискови данни.",
  },
  d = {
    enterpriseTier: "ENTERPRISE TIER",
    title: "Разузнавателна инфраструктура",
    subtitle:
      "За правителства, институции, търговски бюра и организации, нуждаещи се от пълната платформа с максимална сигурност, AI агенти и дълбочина на данните.",
    security: "Сигурност от правителствен клас",
    securityDesc:
      "Air-gapped внедряване, Docker on-premises, отделен облачен клиент, път към SOC 2 Type II, SSO/MFA и пълен одиторски журнал.",
    aiAgents: "AI агенти и MCP",
    aiAgentsDesc:
      "Автономни разузнавателни агенти с инвеститорски профили. Свържете World Monitor като инструмент към Claude, GPT или персонализирани LLMs чрез MCP.",
    dataLayers: "Разширени слоеве данни",
    dataLayersDesc:
      "Десетки хиляди инфраструктурни активи, картографирани глобално. Интеграция на сателитни изображения с засичане на промени и SAR.",
    connectors: "100+ конектора за данни",
    connectorsDesc:
      "PostgreSQL, Snowflake, Splunk, Sentinel, Jira, Slack, Teams и още. Експорт в PDF, PowerPoint, CSV, GeoJSON.",
    whiteLabel: "White-label и вграждаем",
    whiteLabelDesc:
      "Вашият бранд, вашият домейн, вашето десктоп приложение. Вградими iframe панели за SOC стени и търговски зали.",
    financial: "Финансово разузнаване",
    financialDesc:
      "Календар на печалби, данни за енергийни мрежи, разширено проследяване на суровини с извод за товари, скрининг на санкции с AIS корелация.",
    commodity: "Търговия със суровини",
    commodityDesc:
      "Проследяване на кораби + извод за товари + граф на веригата за доставки. Знайте преди пазарът да се раздвижи.",
    government: "Правителства и институции",
    governmentDesc:
      "Air-gapped, AI агенти, пълна ситуационна осведоменост, MCP. Никакви данни не напускат вашата мрежа.",
    risk: "Консултанти по риска",
    riskDesc:
      "Симулация на сценарии, инвеститорски профили, брандирани PDF/PowerPoint доклади при поискване.",
    soc: "SOCs и CERT",
    socDesc:
      "Слой на кибер заплахи, SIEM интеграция, мониторинг на BGP аномалии, ransomware потоци.",
  ...
  D = {
    ...
    shareHint:
      "Споделете линка си, за да се придвижите напред в опашката. Всеки приятел, който се присъедини, ви приближава към началото.",
    copied: "Копирано!",
    ...
    telegram: "Telegram",
    shareText:
      "Току-що се записах в списъка на чакащите за World Monitor Pro — глобално разузнаване в реално време, задвижвано от AI. Присъедини се:",
