const e = {
  ...
  r = {
    ...
    signalWord: "สัญญาณ",
    valueProps:
      "วิจัยหุ้นด้วย AI การวิเคราะห์ภูมิรัฐศาสตร์ และข่าวกรองเศรษฐกิจมหภาค — สัมพันธ์กันแบบเรียลไทม์",
  ...
  a = {
    ...
    description:
      "ลูกโลก 3D WebGL · เลเยอร์แผนที่แบบโต้ตอบกว่า 45+ · ข้อมูลภูมิรัฐศาสตร์ ตลาด พลังงาน และโครงสร้างพื้นฐานแบบเรียลไทม์",
  },
  i = {
    ...
    quote:
      "ข่าวสารกลายเป็นเรื่องยากที่จะวิเคราะห์อย่างแท้จริง อิหร่าน การตัดสินใจของ Trump ตลาดการเงิน แร่ธาตุสำคัญ ความตึงเครียดที่ทวีความรุนแรงจากทุกทิศทางพร้อมกัน ผมต้องการบางอย่างที่แสดงให้เห็นว่าเหตุการณ์เหล่านี้เชื่อมต่อกันอย่างไรแบบเรียลไทม์",
    ceo: "CEO ของ",
  ...
  o = {
    ...
    subtitle:
      "22 โดเมนบริการที่นำเข้าพร้อมกัน ทุกอย่างถูกทำให้เป็นมาตรฐาน ระบุพิกัดภูมิศาสตร์ และแสดงผลบนลูกโลก WebGL พร้อมจุดหมายนับพัน",
    geopolitical: "เหตุการณ์ภูมิรัฐศาสตร์",
    geopoliticalDesc:
      "เหตุการณ์ ACLED & UCDP พร้อมการให้คะแนนระดับความรุนแรงและการวิเคราะห์แนวโน้ม",
    ...
    gdelt: "GDELT & ข่าว",
    gdeltDesc:
      "RSS กว่า 435+ ช่อง เหตุการณ์ GDELT ที่ AI ให้คะแนน การถ่ายทอดสด",
  ...
  n = {
    ...
    subtitle:
      "แดชบอร์ดฟรีแสดงโลกให้คุณเห็น Pro บอกคุณว่ามันหมายความว่าอะไร — และทำให้คุณไม่พลาดสิ่งสำคัญ",
    nearRealTime: "ข้อมูลเกือบเรียลไทม์",
    nearRealTimeDesc:
      "รีเฟรชเร็วขึ้นจาก 5-15 นาที เป็นต่ำกว่า 60 วินาที Pipeline ลำดับความสำคัญสำหรับการแจ้งเตือนของคุณ",
    soWhat: 'การวิเคราะห์ "แล้วไงต่อ?"',
    soWhatDesc:
      "ห่วงโซ่ผลกระทบ การจดจำรูปแบบ การตรวจจับการบรรจบกัน และความสัมพันธ์ระหว่างตลาดกับภูมิรัฐศาสตร์",
    orbitalSurveillance: "การวิเคราะห์การเฝ้าระวังจากวงโคจร",
    orbitalSurveillanceDesc:
      "การพยากรณ์การผ่าน การวิเคราะห์ความถี่ในการกลับมา และการแจ้งเตือนหน้าต่างการถ่ายภาพ รู้ว่าดาวเทียมข่าวกรองกำลังเฝ้าดูพื้นที่ที่คุณสนใจเมื่อใด",
    morningBriefs: "สรุปตอนเช้า & แจ้งเตือนด่วน",
    morningBriefsDesc:
      "AI สังเคราะห์เหตุการณ์ข้ามคืน จัดลำดับตามพื้นที่ที่คุณสนใจ เหตุการณ์สำคัญส่งถึงคุณแบบเรียลไทม์",
    alerting: "การแจ้งเตือนที่ปรับแต่งได้",
    alertingDesc:
      "ตั้งกฎสำหรับการเปลี่ยนแปลง CII เหตุการณ์การบรรจบกัน ความใกล้กับสถานที่ที่บันทึกไว้ และทริกเกอร์ความสัมพันธ์ตลาด",
    oneKey: "22 บริการ, 1 คีย์",
    oneKeyDesc:
      "ACLED, UCDP, Finnhub, FRED, NASA FIRMS, AISStream, OpenSky และอื่น ๆ — ทั้งหมดใช้งานได้ ไม่ต้องลงทะเบียนแยก",
  ...
  l = {
    ...
    critical: "วิกฤต",
    criticalText:
      "การรบกวน GPS ใน 3 โซนบอลติก รูปแบบตรงกับลายเซ็นการหยุดชะงักของโครงสร้างพื้นฐานก่อนหน้านี้ สายเคเบิล NordBalt + Balticconnector อยู่ในพื้นที่ที่ได้รับผลกระทบ",
    elevated: "ยกระดับ",
    elevatedText:
      "ปากีสถาน CII 67→74 เหตุการณ์ประท้วง 12 รายการใหม่ (ลาฮอร์ การาจี อิสลามาบาด) การพุ่งขึ้นที่เปรียบเทียบได้ครั้งล่าสุดเกิดก่อนวิกฤตการเมือง 2024",
    watch: "เฝ้าระวัง",
    watchText:
      "Brent +2.3% จากความผิดปกติ AIS ในช่องแคบฮอร์มุซ เรือมืด 4 ลำใน 6 ชม. การฝึกซ้อม IRGC ประกาศสัปดาห์หน้า",
  },
  c = {
    apiTier: "ระดับ API",
    title: "ข่าวกรองเชิงโปรแกรม",
    subtitle:
      "สำหรับนักพัฒนา นักวิเคราะห์ และทีมที่สร้างบนข้อมูล World Monitor แยกจาก Pro — ใช้ทั้งสองหรืออย่างใดอย่างหนึ่ง",
    ...
    feedData:
      "ป้อนข้อมูลเข้าแดชบอร์ดของคุณ ตั้งระบบแจ้งเตือนอัตโนมัติผ่าน Zapier/n8n/Make สร้างโมเดลการให้คะแนนแบบกำหนดเองบนข้อมูล CII/ความเสี่ยง",
  },
  d = {
    enterpriseTier: "ระดับ ENTERPRISE",
    title: "โครงสร้างพื้นฐานข่าวกรอง",
    subtitle:
      "สำหรับรัฐบาล สถาบัน โต๊ะเทรด และองค์กรที่ต้องการแพลตฟอร์มเต็มรูปแบบพร้อมความปลอดภัยสูงสุด AI agents และข้อมูลเชิงลึก",
    security: "ความปลอดภัยระดับรัฐบาล",
    securityDesc:
      "การติดตั้ง air-gapped, Docker on-premises, cloud tenant เฉพาะ, เส้นทางสู่ SOC 2 Type II, SSO/MFA และบันทึกตรวจสอบครบถ้วน",
    aiAgents: "AI Agents & MCP",
    aiAgentsDesc:
      "Agents ข่าวกรองอัตโนมัติพร้อมโปรไฟล์นักลงทุน เชื่อมต่อ World Monitor เป็นเครื่องมือกับ Claude, GPT หรือ LLM แบบกำหนดเองผ่าน MCP",
    dataLayers: "เลเยอร์ข้อมูลขยาย",
    dataLayersDesc:
      "สินทรัพย์โครงสร้างพื้นฐานนับหมื่นรายการที่แมปทั่วโลก การรวมภาพดาวเทียมพร้อมการตรวจจับการเปลี่ยนแปลงและ SAR",
    connectors: "ตัวเชื่อมต่อข้อมูล 100+",
    connectorsDesc:
      "PostgreSQL, Snowflake, Splunk, Sentinel, Jira, Slack, Teams และอื่น ๆ ส่งออกเป็น PDF, PowerPoint, CSV, GeoJSON",
    whiteLabel: "White-label & ฝังตัวได้",
    whiteLabelDesc:
      "แบรนด์ของคุณ โดเมนของคุณ แอปเดสก์ท็อปของคุณ แผง iframe ฝังตัวได้สำหรับผนัง SOC และห้องเทรด",
    financial: "ข่าวกรองทางการเงิน",
    financialDesc:
      "ปฏิทินผลประกอบการ ข้อมูลกริดพลังงาน การติดตามสินค้าโภคภัณฑ์ขั้นสูงพร้อมการอนุมานสินค้า การคัดกรองการลงโทษพร้อมความสัมพันธ์ AIS",
    commodity: "การซื้อขายสินค้าโภคภัณฑ์",
    commodityDesc:
      "ติดตามเรือ + อนุมานสินค้า + กราฟห่วงโซ่อุปทาน รู้ก่อนตลาดเคลื่อนไหว",
    government: "รัฐบาล & สถาบัน",
    governmentDesc:
      "Air-gapped, AI agents, การรับรู้สถานการณ์เต็มรูปแบบ, MCP ไม่มีข้อมูลออกจากเครือข่ายของคุณ",
    risk: "ที่ปรึกษาด้านความเสี่ยง",
    riskDesc:
      "จำลองสถานการณ์ โปรไฟล์นักลงทุน รายงาน PDF/PowerPoint พร้อมแบรนด์ตามต้องการ",
    soc: "SOC & CERT",
    socDesc:
      "เลเยอร์ภัยคุกคามทางไซเบอร์ การรวม SIEM การตรวจสอบความผิดปกติ BGP ฟีด ransomware",
  ...
  P = {
    ...
    shareHint:
      "แชร์ลิงก์ของคุณเพื่อขยับขึ้นในคิว เพื่อนแต่ละคนที่เข้าร่วมจะดันคุณเข้าใกล้ตำแหน่งหน้าสุด",
    copied: "คัดลอกแล้ว!",
    shareOnX: "แชร์บน X",
    linkedin: "LinkedIn",
    whatsapp: "WhatsApp",
    telegram: "Telegram",
    shareText:
      "ฉันเพิ่งเข้าร่วมรายชื่อรอ World Monitor Pro — ข่าวกรองทั่วโลกแบบเรียลไทม์ขับเคลื่อนด้วย AI มาร่วมกัน:",
