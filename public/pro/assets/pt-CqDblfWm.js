const e = {
  ...
  a = {
    ...
    signalWord: "Sinal",
    valueProps:
      "Pesquisa de acoes impulsionada por IA, analise geopolitica e inteligencia macroeconomica — correlacionadas em tempo real.",
  ...
  o = { asFeaturedIn: "Como destaque em" },
  s = {
    ...
    description:
      "Globo WebGL 3D · 45+ camadas de mapa interativas · Dados geopoliticos, de mercado, energia e infraestrutura em tempo real",
  },
  i = {
    ...
    quote:
      "As noticias ficaram realmente dificeis de interpretar. Ira, decisoes de Trump, mercados financeiros, minerais criticos, tensoes acumulando-se de todas as direcoes simultaneamente. Eu precisava de algo que me mostrasse como esses eventos se conectam em tempo real.",
    ceo: "CEO da",
  ...
  r = {
    ...
    subtitle:
      "22 dominios de servico ingeridos simultaneamente. Tudo normalizado, geolocalizado e renderizado em um globo WebGL com milhares de marcadores.",
    geopolitical: "Eventos geopoliticos",
    geopoliticalDesc:
      "Eventos ACLED & UCDP com pontuacao de escalada e analise de tendencias",
    aviation: "Rastreamento aereo",
    aviationDesc:
      "Rastreamento de transponders ADS-B de padroes de voo globais",
    maritime: "Maritimo & AIS",
    maritimeDesc:
      "Movimentos de embarcacoes, deteccao de navios, atividade portuaria e comercial",
    ...
    internetDesc:
      "Deteccao de interrupcoes, anomalias BGP, zonas de interferencia GPS",
    ...
    gdeltDesc:
      "435+ feeds RSS, eventos GDELT pontuados por IA, transmissoes ao vivo",
    ...
    seismologyDesc:
      "Terremotos USGS, atividade vulcanica, eventos meteorologicos severos",
  },
  t = {
    free: "Gratis",
  ...
  n = {
    ...
    subtitle:
      "O painel gratuito mostra o mundo. O Pro diz o que significa — e garante que voce nunca perca o que importa.",
    nearRealTime: "Dados quase em tempo real",
    nearRealTimeDesc:
      "Atualizacao acelerada de 5-15 min para menos de 60 segundos. Pipeline prioritario para seus alertas.",
    soWhat: 'Analise "E dai?"',
    soWhatDesc:
      "Cadeias de impacto, reconhecimento de padroes, deteccao de convergencias e correlacao mercados-geopolitica.",
    orbitalSurveillance: "Análise de vigilância orbital",
    orbitalSurveillanceDesc:
      "Previsões de passagem, análise de frequência de revisita e alertas de janelas de imagem. Saiba quando satélites de inteligência observam suas áreas de interesse.",
    morningBriefs: "Briefings matinais & Alertas flash",
    morningBriefsDesc:
      "Sintese IA dos desenvolvimentos noturnos classificados pelas suas areas de foco. Eventos urgentes enviados em tempo real.",
    alerting: "Alertas configuraveis",
    alertingDesc:
      "Defina regras para deltas CII, eventos de convergencia, proximidade a locais salvos e gatilhos de correlacao de mercado.",
    oneKey: "22 servicos, 1 chave",
    oneKeyDesc:
      "ACLED, UCDP, Finnhub, FRED, NASA FIRMS, AISStream, OpenSky e mais — tudo ativo, sem registros separados.",
  ...
  d = {
    ...
    critical: "Critico",
    criticalText:
      "Interferencia GPS em 3 zonas balticas. O padrao corresponde a assinaturas anteriores de disrupcao de infraestrutura. Cabo NordBalt + Balticconnector na area afetada.",
    elevated: "Elevado",
    elevatedText:
      "Paquistao CII 67→74. 12 novos eventos de protesto (Lahore, Karachi, Islamabad). O ultimo pico comparavel precedeu a crise politica de 2024.",
    watch: "Vigilancia",
    watchText:
      "Brent +2,3% por anomalia AIS em Hormuz. 4 navios fantasma em 6h. Exercicio IRGC anunciado para a proxima semana.",
  },
  c = {
    apiTier: "PLANO API",
    title: "Inteligencia programatica",
    subtitle:
      "Para desenvolvedores, analistas e equipes que constroem sobre dados do World Monitor. Independente do Pro — use ambos ou qualquer um.",
    restApi: "API REST em todos os 22 dominios de servico",
    authenticated: "Autenticacao por chave, limitacao de taxa por plano",
    structured:
      "JSON estruturado com headers de cache e documentacao OpenAPI 3.1",
    starter: "Starter",
    ...
    feedData:
      "Alimente seus paineis, automatize alertas via Zapier/n8n/Make, construa modelos de pontuacao personalizados sobre dados CII/risco.",
  },
  l = {
    enterpriseTier: "PLANO ENTERPRISE",
    title: "Infraestrutura de inteligencia",
    subtitle:
      "Para governos, instituicoes, mesas de trading e organizacoes que precisam da plataforma completa com seguranca maxima, agentes IA e profundidade de dados.",
    security: "Seguranca de nivel governamental",
    securityDesc:
      "Deploy air-gapped, Docker on-premises, tenant cloud dedicado, caminho SOC 2 Type II, SSO/MFA e trilha de auditoria completa.",
    aiAgents: "Agentes IA & MCP",
    aiAgentsDesc:
      "Agentes de inteligencia autonomos com personas de investidor. Conecte o World Monitor como ferramenta ao Claude, GPT ou LLMs personalizados via MCP.",
    dataLayers: "Camadas de dados expandidas",
    dataLayersDesc:
      "Dezenas de milhares de ativos de infraestrutura mapeados globalmente. Integracao de imagens de satelite com deteccao de mudancas e SAR.",
    connectors: "100+ conectores de dados",
    connectorsDesc:
      "PostgreSQL, Snowflake, Splunk, Sentinel, Jira, Slack, Teams e mais. Exportacao para PDF, PowerPoint, CSV, GeoJSON.",
    whiteLabel: "White-label & Integravel",
    whiteLabelDesc:
      "Sua marca, seu dominio, seu app desktop. Paineis iframe integraveis para paredes SOC e salas de trading.",
    financial: "Inteligencia financeira",
    financialDesc:
      "Calendario de resultados, dados de rede energetica, rastreamento avancado de commodities com inferencia de carga, triagem de sancoes com correlacao AIS.",
    commodity: "Trading de commodities",
    commodityDesc:
      "Rastreamento de navios + inferencia de carga + grafo de cadeia de suprimentos. Saber antes que o mercado se mova.",
    government: "Governos & Instituicoes",
    governmentDesc:
      "Air-gapped, agentes IA, consciencia situacional completa, MCP. Nenhum dado sai da sua rede.",
    risk: "Consultorias de risco",
    riskDesc:
      "Simulacao de cenarios, personas de investidor, relatorios PDF/PowerPoint personalizados sob demanda.",
    soc: "SOCs & CERT",
    socDesc:
      "Camada de ameacas cyber, integracao SIEM, monitoramento de anomalias BGP, feeds de ransomware.",
  ...
  f = {
    ...
    shareHint:
      "Compartilhe seu link para avancar na fila. Cada amigo que entra te aproxima do topo.",
    copied: "Copiado!",
    ...
    telegram: "Telegram",
    shareText:
      "Acabei de entrar na lista de espera do World Monitor Pro — inteligencia global em tempo real com IA. Junte-se a mim:",
