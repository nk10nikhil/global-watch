const i = {
  ...
  e = {
    ...
    signalWord: "Segnale",
    valueProps:
      "Ricerca azionaria potenziata dall'IA, analisi geopolitica e intelligence macroeconomica — correlate in tempo reale.",
  ...
  a = { asFeaturedIn: "Come apparso su" },
  t = {
    ...
    description:
      "Globo WebGL 3D · 45+ livelli mappa interattivi · Dati geopolitici, di mercato, energia e infrastrutture in tempo reale",
  },
  r = {
    ...
    quote:
      "Le notizie sono diventate davvero difficili da decifrare. L'Iran, le decisioni di Trump, i mercati finanziari, i minerali critici, tensioni che si accumulavano contemporaneamente da ogni direzione. Avevo bisogno di qualcosa che mi mostrasse come questi eventi si collegano tra loro in tempo reale.",
    ceo: "CEO di",
  ...
  o = {
    ...
    subtitle:
      "22 domini di servizio acquisiti simultaneamente. Tutto normalizzato, geolocalizzato e renderizzato su un globo WebGL con migliaia di marcatori.",
    geopolitical: "Eventi geopolitici",
    geopoliticalDesc:
      "Eventi ACLED & UCDP con punteggio di escalation e analisi dei trend",
    aviation: "Tracciamento aereo",
    aviationDesc: "Tracciamento transponder ADS-B dei pattern di volo globali",
    maritime: "Marittimo & AIS",
    maritimeDesc:
      "Movimenti navali, rilevamento imbarcazioni, attività portuale e commerciale",
    ...
    internetDesc:
      "Rilevamento interruzioni, anomalie BGP, zone di disturbo GPS",
    ...
    gdelt: "GDELT & Notizie",
    gdeltDesc:
      "435+ feed RSS, eventi GDELT valutati dall'IA, trasmissioni in diretta",
    ...
    seismologyDesc:
      "Terremoti USGS, attività vulcanica, eventi meteorologici estremi",
  },
  n = {
    free: "Gratis",
  ...
  s = {
    ...
    subtitle:
      "La dashboard gratuita ti mostra il mondo. Pro ti dice cosa significa — e si assicura che non ti perda mai ciò che conta.",
    nearRealTime: "Dati quasi in tempo reale",
    nearRealTimeDesc:
      "Aggiornamento accelerato da 5-15 min a meno di 60 secondi. Pipeline prioritaria per i tuoi alert.",
    soWhat: 'Analisi "E quindi?"',
    soWhatDesc:
      "Catene di impatto, riconoscimento di pattern, rilevamento di convergenze e correlazione mercati-geopolitica.",
    orbitalSurveillance: "Analisi di sorveglianza orbitale",
    orbitalSurveillanceDesc:
      "Previsioni di passaggio, analisi della frequenza di rivisita e avvisi delle finestre di imaging. Sapere quando i satelliti di intelligence osservano le vostre aree di interesse.",
    morningBriefs: "Briefing mattutini & Alert flash",
    morningBriefsDesc:
      "Sintesi IA degli sviluppi notturni classificati per le tue aree di interesse. Eventi urgenti inviati in tempo reale.",
    alerting: "Alert configurabili",
    alertingDesc:
      "Imposta regole per delta CII, eventi di convergenza, prossimità a posizioni salvate e trigger di correlazione di mercato.",
    oneKey: "22 servizi, 1 chiave",
    oneKeyDesc:
      "ACLED, UCDP, Finnhub, FRED, NASA FIRMS, AISStream, OpenSky e altro — tutto attivo, nessuna registrazione separata.",
  ...
  l = {
    ...
    critical: "Critico",
    criticalText:
      "Disturbo GPS in 3 zone baltiche. Il pattern corrisponde a firme precedenti di interruzione infrastrutturale. Cavo NordBalt + Balticconnector nell'area interessata.",
    elevated: "Elevato",
    elevatedText:
      "Pakistan CII 67→74. 12 nuovi eventi di protesta (Lahore, Karachi, Islamabad). L'ultimo picco comparabile ha preceduto la crisi politica del 2024.",
    watch: "Sorveglianza",
    watchText:
      "Brent +2,3% su anomalia AIS a Hormuz. 4 navi fantasma in 6h. Esercitazione IRGC annunciata per la prossima settimana.",
  },
  c = {
    apiTier: "PIANO API",
    title: "Intelligence programmatica",
    subtitle:
      "Per sviluppatori, analisti e team che costruiscono sui dati di World Monitor. Indipendente da Pro — usa entrambi o uno solo.",
    restApi: "API REST su tutti i 22 domini di servizio",
    authenticated: "Autenticazione per chiave, rate limiting per piano",
    structured:
      "JSON strutturato con header di cache e documentazione OpenAPI 3.1",
    starter: "Starter",
    ...
    feedData:
      "Alimenta le tue dashboard, automatizza gli alert tramite Zapier/n8n/Make, costruisci modelli di scoring personalizzati su dati CII/rischio.",
  },
  d = {
    enterpriseTier: "PIANO ENTERPRISE",
    title: "Infrastruttura di intelligence",
    subtitle:
      "Per governi, istituzioni, desk di trading e organizzazioni che necessitano della piattaforma completa con massima sicurezza, agenti IA e profondità dati.",
    security: "Sicurezza di livello governativo",
    securityDesc:
      "Deploy air-gapped, Docker on-premises, tenant cloud dedicato, percorso SOC 2 Type II, SSO/MFA e audit trail completo.",
    aiAgents: "Agenti IA & MCP",
    aiAgentsDesc:
      "Agenti di intelligence autonomi con persona investitore. Connetti World Monitor come strumento a Claude, GPT o LLM personalizzati via MCP.",
    dataLayers: "Livelli dati estesi",
    dataLayersDesc:
      "Decine di migliaia di asset infrastrutturali mappati globalmente. Integrazione di immagini satellitari con rilevamento cambiamenti e SAR.",
    connectors: "100+ connettori dati",
    connectorsDesc:
      "PostgreSQL, Snowflake, Splunk, Sentinel, Jira, Slack, Teams e altro. Esportazione in PDF, PowerPoint, CSV, GeoJSON.",
    whiteLabel: "White-label & Integrabile",
    whiteLabelDesc:
      "Il tuo brand, il tuo dominio, la tua app desktop. Pannelli iframe integrabili per pareti SOC e sale di trading.",
    financial: "Intelligence finanziaria",
    financialDesc:
      "Calendario utili, dati rete energetica, tracciamento avanzato materie prime con inferenza del carico, screening sanzioni con correlazione AIS.",
    commodity: "Trading di materie prime",
    commodityDesc:
      "Tracciamento navi + inferenza del carico + grafo della catena di fornitura. Sapere prima che il mercato si muova.",
    government: "Governi & Istituzioni",
    governmentDesc:
      "Air-gapped, agenti IA, consapevolezza situazionale completa, MCP. Nessun dato lascia la tua rete.",
    risk: "Consulenze di rischio",
    riskDesc:
      "Simulazione di scenari, persona investitore, report PDF/PowerPoint personalizzati on demand.",
    soc: "SOCs & CERT",
    socDesc:
      "Livello minacce cyber, integrazione SIEM, monitoraggio anomalie BGP, feed ransomware.",
  ...
  v = {
    ...
    shareHint:
      "Condividi il tuo link per avanzare in coda. Ogni amico che si iscrive ti avvicina alla testa della lista.",
    copied: "Copiato!",
    ...
    telegram: "Telegram",
    shareText:
      "Mi sono appena iscritto alla lista d'attesa di World Monitor Pro — intelligence globale in tempo reale alimentata dall'IA. Unisciti a me:",
