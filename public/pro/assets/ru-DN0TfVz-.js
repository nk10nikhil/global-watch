const e = {
  ...
  r = {
    ...
    signalWord: "Сигнал",
    valueProps:
      "ИИ-аналитика акций, геополитический анализ и макроэкономическая разведка — в реальном времени.",
  ...
  o = { asFeaturedIn: "Как опубликовано в" },
  t = {
    ...
    description:
      "3D-глобус WebGL · 45+ интерактивных слоёв карты · Геополитические, финансовые, энергетические и инфраструктурные данные в реальном времени",
  },
  a = {
    ...
    quote:
      "Разобраться в новостях стало по-настоящему сложно. Иран, решения Трампа, финансовые рынки, критические ресурсы, напряжённость нарастает одновременно со всех сторон. Мне нужен был инструмент, показывающий, как эти события связаны между собой в реальном времени.",
    ceo: "CEO",
    asToldTo: "в интервью",
  },
  i = {
    ...
    subtitle:
      "22 сервисных домена обрабатываются одновременно. Все данные нормализуются, геокодируются и отображаются на WebGL-глобусе с тысячами маркеров.",
    geopolitical: "Геополитические события",
    geopoliticalDesc:
      "События ACLED и UCDP с оценкой эскалации и анализом трендов",
    ...
    maritimeDesc:
      "Движение судов, обнаружение кораблей, активность портов и торговли",
    ...
    gdeltDesc:
      "435+ RSS-каналов, события GDELT с ИИ-оценкой, прямые трансляции",
    ...
    seismologyDesc:
      "Землетрясения USGS, вулканическая активность, экстремальная погода",
  },
  s = {
    free: "Бесплатно",
  ...
  n = {
    ...
    subtitle:
      "Бесплатный дашборд показывает мир. Pro объясняет, что это значит — и гарантирует, что вы не пропустите важное.",
    nearRealTime: "Данные почти в реальном времени",
    nearRealTimeDesc:
      "Обновление ускорено с 5-15 минут до менее 60 секунд. Приоритетный канал для ваших оповещений.",
    soWhat: "Анализ «И что?»",
    soWhatDesc:
      "Цепочки влияния, распознавание паттернов, обнаружение конвергенции и рыночно-геополитические корреляции.",
    orbitalSurveillance: "Анализ орбитального наблюдения",
    orbitalSurveillanceDesc:
      "Прогнозы пролётов, анализ частоты ревизитов и оповещения об окнах съёмки. Знайте, когда разведывательные спутники наблюдают за вашими зонами интереса.",
    morningBriefs: "Утренние сводки и срочные оповещения",
    morningBriefsDesc:
      "ИИ-синтез ночных событий, ранжированных по вашим интересам. Экстренные события доставляются мгновенно.",
    alerting: "Настраиваемые оповещения",
    alertingDesc:
      "Задайте правила для изменений CII, событий конвергенции, близости к сохранённым локациям и триггеров рыночной корреляции.",
    oneKey: "22 сервиса, 1 ключ",
    oneKeyDesc:
      "ACLED, UCDP, Finnhub, FRED, NASA FIRMS, AISStream, OpenSky и другие — всё активно, без отдельных регистраций.",
  ...
  l = {
    ...
    criticalText:
      "Подавление GPS в 3 зонах Балтики. Паттерн совпадает с предыдущими сигнатурами нарушения инфраструктуры. Кабель NordBalt + Balticconnector в зоне поражения.",
    elevated: "Повышенный",
    elevatedText:
      "CII Пакистана 67→74. 12 новых протестных событий (Лахор, Карачи, Исламабад). Последний аналогичный скачок предшествовал политическому кризису 2024.",
    watch: "Наблюдение",
    watchText:
      "Brent +2.3% на аномалии AIS в Хормузе. 4 тёмных судна за 6 ч. КСИР объявил учения на следующей неделе.",
  },
  c = {
    apiTier: "ТАРИФ API",
    title: "Программная аналитика",
    subtitle:
      "Для разработчиков, аналитиков и команд, работающих с данными World Monitor. Независимо от Pro — используйте оба или любой из них.",
    restApi: "REST API по всем 22 сервисным доменам",
    authenticated: "Аутентификация по ключу, лимиты по тарифу",
    structured:
      "Структурированный JSON с заголовками кеша и документацией OpenAPI 3.1",
    starter: "Starter",
    ...
    feedData:
      "Подключайте данные к своим дашбордам, автоматизируйте оповещения через Zapier/n8n/Make, создавайте модели оценки на основе CII/рисков.",
  },
  d = {
    enterpriseTier: "КОРПОРАТИВНЫЙ ТАРИФ",
    title: "Разведывательная инфраструктура",
    subtitle:
      "Для правительств, учреждений, трейдинговых деск и организаций, которым нужна полная платформа с максимальной безопасностью, ИИ-агентами и глубиной данных.",
    security: "Безопасность государственного уровня",
    securityDesc:
      "Изолированное развёртывание, локальный Docker, выделенный облачный тенант, путь к SOC 2 Type II, SSO/MFA и полный аудит.",
    aiAgents: "ИИ-агенты и MCP",
    aiAgentsDesc:
      "Автономные разведывательные агенты с профилями инвесторов. Подключите World Monitor как инструмент к Claude, GPT или пользовательским LLM через MCP.",
    dataLayers: "Расширенные слои данных",
    dataLayersDesc:
      "Десятки тысяч объектов инфраструктуры на глобальной карте. Интеграция спутниковых снимков с обнаружением изменений и SAR.",
    connectors: "100+ коннекторов данных",
    connectorsDesc:
      "PostgreSQL, Snowflake, Splunk, Sentinel, Jira, Slack, Teams и другие. Экспорт в PDF, PowerPoint, CSV, GeoJSON.",
    whiteLabel: "White-label и встраиваемое решение",
    whiteLabelDesc:
      "Ваш бренд, ваш домен, ваше десктопное приложение. Встраиваемые iframe-панели для SOC-центров и торговых залов.",
    financial: "Финансовая аналитика",
    financialDesc:
      "Календарь отчётностей, данные энергосетей, расширенное отслеживание сырья с выводом о грузах, скрининг санкций с корреляцией AIS.",
    commodity: "Торговля сырьём",
    commodityDesc:
      "Отслеживание судов + вывод о грузах + граф цепочки поставок. Узнавайте до того, как рынок отреагирует.",
    government: "Правительства и учреждения",
    governmentDesc:
      "Изолированное развёртывание, ИИ-агенты, полная ситуационная осведомлённость, MCP. Данные не покидают вашу сеть.",
    risk: "Консалтинг по рискам",
    riskDesc:
      "Моделирование сценариев, профили инвесторов, брендированные отчёты PDF/PowerPoint по запросу.",
    soc: "SOCs и CERT",
    socDesc:
      "Слой киберугроз, интеграция с SIEM, мониторинг аномалий BGP, потоки данных о вымогателях.",
  ...
  p = {
    ...
    shareHint:
      "Поделитесь ссылкой, чтобы продвинуться в очереди. Каждый присоединившийся друг приближает вас к началу.",
    copied: "Скопировано!",
    ...
    telegram: "Telegram",
    shareText:
      "Я записался в лист ожидания World Monitor Pro — глобальная аналитика в реальном времени на базе ИИ. Присоединяйтесь:",
