const e = {
  ...
  r = {
    ...
    signalWord: "Σήμα",
    valueProps:
      "Έρευνα μετοχών με AI, γεωπολιτική ανάλυση και μακροοικονομική πληροφόρηση — συσχετισμένα σε πραγματικό χρόνο.",
  ...
  t = { asFeaturedIn: "Όπως παρουσιάστηκε στο" },
  a = {
    ...
    description:
      "3D WebGL υδρόγειος · 45+ διαδραστικά επίπεδα χάρτη · Γεωπολιτικά, χρηματοοικονομικά, ενεργειακά και δεδομένα υποδομών σε πραγματικό χρόνο",
  },
  i = {
    ...
    quote:
      "Οι ειδήσεις έγιναν πραγματικά δύσκολες στην ανάλυση. Ιράν, αποφάσεις του Trump, χρηματοπιστωτικές αγορές, κρίσιμα ορυκτά, εντάσεις που κλιμακώνονται ταυτόχρονα από κάθε κατεύθυνση. Χρειαζόμουν κάτι που μου δείχνει πώς αυτά τα γεγονότα συνδέονται μεταξύ τους σε πραγματικό χρόνο.",
    ceo: "CEO της",
  ...
  s = {
    ...
    subtitle:
      "22 τομείς δεδομένων που εισάγονται ταυτόχρονα. Τα πάντα κανονικοποιημένα, γεωεντοπισμένα και αποδιδόμενα σε υδρόγειο WebGL με χιλιάδες δείκτες.",
    geopolitical: "Γεωπολιτικά γεγονότα",
    geopoliticalDesc:
      "Γεγονότα ACLED & UCDP με βαθμολογία κλιμάκωσης και ανάλυση τάσεων",
    aviation: "Παρακολούθηση αεροπορίας",
    aviationDesc:
      "Παρακολούθηση παγκόσμιων πτητικών μοτίβων μέσω ADS-B transponder",
    maritime: "Ναυτιλία & AIS",
    maritimeDesc:
      "Κινήσεις πλοίων, ανίχνευση σκαφών, λιμενική και εμπορική δραστηριότητα",
    fire: "Δορυφορική ανίχνευση πυρκαγιών",
    fireDesc:
      "Δεδομένα πυρκαγιών και θερμικών εστιών σχεδόν πραγματικού χρόνου από NASA FIRMS",
    ...
    marketsDesc:
      "Μετοχές, εμπορεύματα, κρυπτονομίσματα, ροές ETF, μακροοικονομικά δεδομένα FRED",
    cyber: "Κυβερνοαπειλές",
    cyberDesc: "Ροές ransomware, υποκλοπές BGP, ανίχνευση DDoS",
    gdelt: "GDELT & Ειδήσεις",
    gdeltDesc:
      "435+ RSS κανάλια, γεγονότα GDELT με βαθμολογία AI, ζωντανές μεταδόσεις",
    ...
    seismologyDesc:
      "Σεισμοί USGS, ηφαιστειακή δραστηριότητα, σοβαρά καιρικά φαινόμενα",
  },
  o = {
    free: "Δωρεάν",
  ...
  n = {
    ...
    subtitle:
      "Ο δωρεάν πίνακας ελέγχου σας δείχνει τον κόσμο. Το Pro σας λέει τι σημαίνει — και φροντίζει να μην χάσετε ποτέ ό,τι μετράει.",
    nearRealTime: "Δεδομένα σχεδόν πραγματικού χρόνου",
    nearRealTimeDesc:
      "Ανανέωση επιταχυμένη από 5-15 λεπτά σε λιγότερο από 60 δευτερόλεπτα. Pipeline προτεραιότητας για τις ειδοποιήσεις σας.",
    soWhat: "Ανάλυση «Και λοιπόν;»",
    soWhatDesc:
      "Αλυσίδες επιπτώσεων, αναγνώριση μοτίβων, ανίχνευση σύγκλισης και συσχέτιση αγοράς-γεωπολιτικής.",
    orbitalSurveillance: "Ανάλυση Τροχιακής Επιτήρησης",
    orbitalSurveillanceDesc:
      "Προβλέψεις υπερπτήσεων, ανάλυση συχνότητας επανεπισκέψεων και ειδοποιήσεις για παράθυρα απεικόνισης. Μάθετε πότε δορυφόροι πληροφοριών παρακολουθούν τις περιοχές ενδιαφέροντός σας.",
    morningBriefs: "Πρωινές ενημερώσεις & Άμεσες ειδοποιήσεις",
    morningBriefsDesc:
      "Συνθετική ανάλυση AI για τις νυχτερινές εξελίξεις, ταξινομημένες κατά τους τομείς ενδιαφέροντός σας. Έκτακτα γεγονότα σε πραγματικό χρόνο.",
    alerting: "Παραμετροποιήσιμες ειδοποιήσεις",
    alertingDesc:
      "Ορίστε κανόνες για μεταβολές CII, γεγονότα σύγκλισης, εγγύτητα σε αποθηκευμένες τοποθεσίες και triggers συσχέτισης αγοράς.",
    oneKey: "22 υπηρεσίες, 1 κλειδί",
    oneKeyDesc:
      "ACLED, UCDP, Finnhub, FRED, NASA FIRMS, AISStream, OpenSky και άλλα — όλα ενεργά, χωρίς ξεχωριστές εγγραφές.",
  ...
  l = {
    ...
    critical: "Κρίσιμο",
    criticalText:
      "Παρεμβολή GPS σε 3 ζώνες της Βαλτικής. Το μοτίβο ταιριάζει με προηγούμενες υπογραφές διαταραχής υποδομών. Καλώδιο NordBalt + Balticconnector στην πληγείσα περιοχή.",
    elevated: "Αυξημένο",
    elevatedText:
      "Πακιστάν CII 67→74. 12 νέα γεγονότα διαμαρτυρίας (Λαχώρη, Καράτσι, Ισλαμαμπάντ). Η τελευταία αντίστοιχη αύξηση προηγήθηκε της πολιτικής κρίσης του 2024.",
    watch: "Παρακολούθηση",
    watchText:
      "Brent +2.3% λόγω ανωμαλίας AIS στο Ορμούζ. 4 σκοτεινά πλοία σε 6 ώρες. Άσκηση IRGC ανακοινώθηκε για την επόμενη εβδομάδα.",
  },
  c = {
    apiTier: "ΕΠΙΠΕΔΟ API",
    title: "Προγραμματιστική πρόσβαση σε πληροφορίες",
    subtitle:
      "Για προγραμματιστές, αναλυτές και ομάδες που χτίζουν πάνω σε δεδομένα World Monitor. Ανεξάρτητο από το Pro — χρησιμοποιήστε και τα δύο ή μόνο ένα.",
    ...
    feedData:
      "Τροφοδοτήστε δεδομένα στους πίνακες ελέγχου σας, αυτοματοποιήστε ειδοποιήσεις μέσω Zapier/n8n/Make, δημιουργήστε προσαρμοσμένα μοντέλα βαθμολόγησης σε δεδομένα CII/κινδύνου.",
  },
  d = {
    enterpriseTier: "ΕΠΙΠΕΔΟ ENTERPRISE",
    title: "Υποδομή πληροφοριών",
    subtitle:
      "Για κυβερνήσεις, θεσμούς, trading desks και οργανισμούς που χρειάζονται την πλήρη πλατφόρμα με μέγιστη ασφάλεια, AI agents και βάθος δεδομένων.",
    security: "Ασφάλεια κυβερνητικού επιπέδου",
    securityDesc:
      "Air-gapped ανάπτυξη, Docker on-premises, αποκλειστικός cloud tenant, πορεία προς SOC 2 Type II, SSO/MFA και πλήρες ίχνος ελέγχου.",
    aiAgents: "AI Agents & MCP",
    aiAgentsDesc:
      "Αυτόνομοι agents πληροφοριών με προφίλ επενδυτών. Συνδέστε το World Monitor ως εργαλείο στο Claude, GPT ή προσαρμοσμένα LLM μέσω MCP.",
    dataLayers: "Εκτεταμένα επίπεδα δεδομένων",
    dataLayersDesc:
      "Δεκάδες χιλιάδες στοιχεία υποδομών χαρτογραφημένα παγκοσμίως. Ενσωμάτωση δορυφορικών εικόνων με ανίχνευση αλλαγών και SAR.",
    connectors: "100+ σύνδεσμοι δεδομένων",
    connectorsDesc:
      "PostgreSQL, Snowflake, Splunk, Sentinel, Jira, Slack, Teams και άλλα. Εξαγωγή σε PDF, PowerPoint, CSV, GeoJSON.",
    whiteLabel: "White-label & Ενσωματώσιμο",
    whiteLabelDesc:
      "Η δική σας μάρκα, ο δικός σας τομέας, η δική σας εφαρμογή desktop. Ενσωματώσιμα iframe panels για τοίχους SOC και αίθουσες συναλλαγών.",
    financial: "Χρηματοοικονομική πληροφόρηση",
    financialDesc:
      "Ημερολόγιο αποτελεσμάτων, δεδομένα ενεργειακού δικτύου, βελτιωμένη παρακολούθηση εμπορευμάτων με εκτίμηση φορτίου, έλεγχος κυρώσεων με συσχέτιση AIS.",
    commodity: "Εμπόριο εμπορευμάτων",
    commodityDesc:
      "Παρακολούθηση πλοίων + εκτίμηση φορτίου + γράφημα αλυσίδας εφοδιασμού. Μάθετε πριν κινηθεί η αγορά.",
    government: "Κυβέρνηση & Θεσμοί",
    governmentDesc:
      "Air-gapped, AI agents, πλήρης επίγνωση κατάστασης, MCP. Κανένα δεδομένο δεν φεύγει από το δίκτυό σας.",
    risk: "Σύμβουλοι κινδύνου",
    riskDesc:
      "Προσομοίωση σεναρίων, προφίλ επενδυτών, επώνυμες αναφορές PDF/PowerPoint κατ' απαίτηση.",
    soc: "SOC & CERT",
    socDesc:
      "Επίπεδο κυβερνοαπειλών, ενσωμάτωση SIEM, παρακολούθηση ανωμαλιών BGP, ροές ransomware.",
  ...
  P = {
    ...
    shareHint:
      "Μοιραστείτε τον σύνδεσμό σας για να ανεβείτε στη σειρά. Κάθε φίλος που εγγράφεται σας φέρνει πιο κοντά στην αρχή.",
    copied: "Αντιγράφηκε!",
    ...
    telegram: "Telegram",
    shareText:
      "Μόλις εγγράφηκα στη λίστα αναμονής του World Monitor Pro — πληροφορίες παγκόσμιας εμβέλειας σε πραγματικό χρόνο με AI. Ελάτε κι εσείς:",
