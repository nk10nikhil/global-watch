const e = {
  ...
  n = {
    ...
    signalWord: "Signal",
    valueProps:
      "KI-gestützte Aktienanalyse, geopolitische Analyse und Makro-Intelligence — in Echtzeit korreliert.",
  ...
  i = {
    ...
    description:
      "3D-WebGL-Globus · 45+ interaktive Kartenebenen · Geopolitische, Markt-, Energie- und Infrastrukturdaten in Echtzeit",
  },
  t = {
    ...
    quote:
      "Die Nachrichtenlage wurde wirklich schwer zu durchschauen. Iran, Trumps Entscheidungen, Finanzmärkte, kritische Rohstoffe, Spannungen, die sich gleichzeitig aus allen Richtungen aufbauten. Ich brauchte etwas, das mir zeigt, wie diese Ereignisse in Echtzeit zusammenhängen.",
    ceo: "CEO von",
  ...
  s = {
    ...
    subtitle:
      "22 Servicebereiche werden gleichzeitig erfasst. Alles normalisiert, georeferenziert und auf einem WebGL-Globus mit Tausenden von Markern dargestellt.",
    geopolitical: "Geopolitische Ereignisse",
    geopoliticalDesc:
      "ACLED- & UCDP-Ereignisse mit Eskalationsbewertung und Trendanalyse",
    aviation: "Flugverkehr-Tracking",
    aviationDesc: "ADS-B-Transponder-Tracking globaler Flugbewegungen",
    maritime: "Seeverkehr & AIS",
    maritimeDesc:
      "Schiffsbewegungen, Schiffserkennung, Hafen- und Handelsaktivität",
    ...
    gdeltDesc:
      "435+ RSS-Feeds, KI-bewertete GDELT-Ereignisse, Live-Übertragungen",
  ...
  l = {
    ...
    subtitle:
      "Das kostenlose Dashboard zeigt Ihnen die Welt. Pro sagt Ihnen, was es bedeutet — und sorgt dafür, dass Sie nie verpassen, was wichtig ist.",
    nearRealTime: "Nah-Echtzeit-Daten",
    nearRealTimeDesc:
      "Aktualisierung beschleunigt von 5-15 Min. auf unter 60 Sekunden. Prioritäts-Pipeline für Ihre Alerts.",
    soWhat: '„Na und?"-Analyse',
    soWhatDesc:
      "Wirkungsketten, Mustererkennung, Konvergenzerkennung und Markt-Geopolitik-Korrelation.",
    orbitalSurveillance: "Orbitale Überwachungsanalyse",
    orbitalSurveillanceDesc:
      "Überflug-Vorhersagen, Revisit-Frequenzanalyse und Aufnahme-Fenster-Alerts. Wissen Sie, wann Aufklärungssatelliten Ihre Interessengebiete beobachten.",
    morningBriefs: "Morgenbriefings & Flash-Alerts",
    morningBriefsDesc:
      "KI-synthetisierte Nachtentwicklungen, priorisiert nach Ihren Fokusgebieten. Eilmeldungen in Echtzeit gepusht.",
    alerting: "Konfigurierbare Alerts",
    alertingDesc:
      "Definieren Sie Regeln für CII-Deltas, Konvergenzereignisse, Nähe zu gespeicherten Orten und Marktkorrelations-Trigger.",
    oneKey: "22 Services, 1 Schlüssel",
    oneKeyDesc:
      "ACLED, UCDP, Finnhub, FRED, NASA FIRMS, AISStream, OpenSky und mehr — alles aktiv, keine separaten Registrierungen.",
  ...
  o = {
    ...
    critical: "Kritisch",
    criticalText:
      "GPS-Störung in 3 baltischen Zonen. Muster stimmt mit früheren Infrastrukturstörungs-Signaturen überein. NordBalt-Kabel + Balticconnector im betroffenen Gebiet.",
    elevated: "Erhöht",
    elevatedText:
      "Pakistan CII 67→74. 12 neue Protestvorfälle (Lahore, Karachi, Islamabad). Letzter vergleichbarer Anstieg ging der politischen Krise 2024 voraus.",
    watch: "Beobachtung",
    watchText:
      "Brent +2,3% bei Hormuz-AIS-Anomalie. 4 Dunkelschiffe in 6 Std. IRGC-Übung nächste Woche angekündigt.",
  },
  u = {
    apiTier: "API-TARIF",
    title: "Programmatische Intelligence",
    subtitle:
      "Für Entwickler, Analysten und Teams, die auf World-Monitor-Daten aufbauen. Unabhängig von Pro — nutzen Sie beides oder eines.",
    restApi: "REST API über alle 22 Servicebereiche",
    authenticated: "Schlüssel-authentifiziert, Rate-Limiting pro Tarif",
    structured:
      "Strukturiertes JSON mit Cache-Headern und OpenAPI-3.1-Dokumentation",
    starter: "Starter",
    ...
    feedData:
      "Speisen Sie Daten in Ihre Dashboards ein, automatisieren Sie Alerts über Zapier/n8n/Make, erstellen Sie eigene Scoring-Modelle auf CII-/Risikodaten.",
  },
  c = {
    enterpriseTier: "ENTERPRISE-TARIF",
    title: "Intelligence-Infrastruktur",
    subtitle:
      "Für Regierungen, Institutionen, Trading Desks und Organisationen, die die volle Plattform mit maximaler Sicherheit, KI-Agenten und Datenbreite benötigen.",
    security: "Sicherheit auf Regierungsniveau",
    securityDesc:
      "Air-Gapped-Deployment, On-Premises-Docker, dedizierter Cloud-Mandant, SOC 2 Type II-Pfad, SSO/MFA und vollständiger Audit-Trail.",
    aiAgents: "KI-Agenten & MCP",
    aiAgentsDesc:
      "Autonome Intelligence-Agenten mit Investoren-Personas. Verbinden Sie World Monitor als Tool mit Claude, GPT oder eigenen LLMs über MCP.",
    dataLayers: "Erweiterte Datenebenen",
    dataLayersDesc:
      "Zehntausende Infrastruktur-Assets weltweit kartiert. Satellitenbildintegration mit Veränderungserkennung und SAR.",
    connectors: "100+ Datenkonnektoren",
    connectorsDesc:
      "PostgreSQL, Snowflake, Splunk, Sentinel, Jira, Slack, Teams und mehr. Export als PDF, PowerPoint, CSV, GeoJSON.",
    whiteLabel: "White-Label & einbettbar",
    whiteLabelDesc:
      "Ihre Marke, Ihre Domain, Ihre Desktop-App. Einbettbare iframe-Panels für SOC-Wände und Handelsräume.",
    financial: "Finanz-Intelligence",
    financialDesc:
      "Ergebniskalender, Energienetz-Daten, erweitertes Rohstoff-Tracking mit Ladungsinferenz, Sanktionsscreening mit AIS-Korrelation.",
    commodity: "Rohstoffhandel",
    commodityDesc:
      "Schiffsverfolgung + Ladungsinferenz + Lieferkettengraph. Wissen, bevor der Markt reagiert.",
    government: "Regierungen & Institutionen",
    governmentDesc:
      "Air-Gapped, KI-Agenten, vollständiges Lagebild, MCP. Keine Daten verlassen Ihr Netzwerk.",
    risk: "Risikoberatungen",
    riskDesc:
      "Szenariosimulation, Investoren-Personas, gebrandete PDF-/PowerPoint-Berichte auf Abruf.",
    soc: "SOCs & CERT",
    socDesc:
      "Cyberbedrohungs-Ebene, SIEM-Integration, BGP-Anomalie-Monitoring, Ransomware-Feeds.",
  ...
  b = {
    ...
    shareHint:
      "Teilen Sie Ihren Link, um in der Warteschlange aufzurücken. Jeder Freund, der beitritt, bringt Sie näher an die Spitze.",
    copied: "Kopiert!",
    ...
    telegram: "Telegram",
    shareText:
      "Ich bin gerade der World Monitor Pro-Warteliste beigetreten — globale Echtzeit-Intelligence mit KI. Mach mit:",
