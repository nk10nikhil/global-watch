const e = {
  ...
  a = {
    ...
    signalWord: "Señal",
    valueProps:
      "Investigación de acciones impulsada por IA, análisis geopolítico e inteligencia macroeconómica — correlacionados en tiempo real.",
  ...
  i = {
    ...
    description:
      "Globo WebGL 3D · 45+ capas de mapa interactivas · Datos geopolíticos, de mercados, energía e infraestructura en tiempo real",
  },
  o = {
    ...
    quote:
      "Las noticias se volvieron realmente difíciles de interpretar. Irán, las decisiones de Trump, los mercados financieros, los minerales críticos, tensiones acumulándose desde todas las direcciones simultáneamente. Necesitaba algo que me mostrara cómo estos eventos se conectan entre sí en tiempo real.",
    ceo: "CEO de",
  ...
  r = {
    ...
    subtitle:
      "22 dominios de servicio ingeridos simultáneamente. Todo normalizado, geolocalizado y renderizado en un globo WebGL con miles de marcadores.",
    geopolitical: "Eventos geopolíticos",
    geopoliticalDesc:
      "Eventos ACLED & UCDP con puntuación de escalada y análisis de tendencias",
    aviation: "Seguimiento aéreo",
    aviationDesc:
      "Seguimiento de transpondedores ADS-B de patrones de vuelo globales",
    maritime: "Marítimo & AIS",
    maritimeDesc:
      "Movimientos de buques, detección de embarcaciones, actividad portuaria y comercial",
    fire: "Detección satelital de incendios",
    fireDesc:
      "Datos de incendios y puntos calientes en casi tiempo real de NASA FIRMS",
    cables: "Cables submarinos",
    cablesDesc: "Rutas de cables submarinos y estaciones de aterrizaje",
    internet: "Internet & GPS",
    internetDesc:
      "Detección de caídas, anomalías BGP, zonas de interferencia GPS",
    ...
    marketsDesc:
      "Acciones, materias primas, cripto, flujos ETF, datos macro FRED",
    cyber: "Amenazas cibernéticas",
    cyberDesc: "Feeds de ransomware, secuestros BGP, detección DDoS",
    gdelt: "GDELT & Noticias",
    gdeltDesc:
      "435+ feeds RSS, eventos GDELT puntuados por IA, transmisiones en vivo",
    unrest: "Disturbios civiles & Desplazamientos",
    unrestDesc:
      "Protestas, flujos de refugiados, datos de desplazamiento UNHCR",
    seismology: "Sismología & Eventos naturales",
    seismologyDesc:
      "Terremotos USGS, actividad volcánica, fenómenos meteorológicos severos",
  },
  n = {
    free: "Gratis",
  ...
  t = {
    ...
    subtitle:
      "El panel gratuito te muestra el mundo. Pro te dice qué significa — y se asegura de que nunca te pierdas lo importante.",
    nearRealTime: "Datos en casi tiempo real",
    nearRealTimeDesc:
      "Actualización acelerada de 5-15 min a menos de 60 segundos. Pipeline prioritario para tus alertas.",
    soWhat: 'Análisis "¿Y qué?"',
    soWhatDesc:
      "Cadenas de impacto, reconocimiento de patrones, detección de convergencias y correlación mercados-geopolítica.",
    orbitalSurveillance: "Análisis de vigilancia orbital",
    orbitalSurveillanceDesc:
      "Predicciones de paso, análisis de frecuencia de revisita y alertas de ventanas de imagen. Sepa cuándo los satélites de inteligencia observan sus áreas de interés.",
    morningBriefs: "Briefings matutinos & Alertas flash",
    morningBriefsDesc:
      "Síntesis IA de los desarrollos nocturnos clasificados por tus áreas de interés. Eventos urgentes enviados en tiempo real.",
    alerting: "Alertas configurables",
    alertingDesc:
      "Define reglas para deltas CII, eventos de convergencia, proximidad a ubicaciones guardadas y disparadores de correlación de mercado.",
    oneKey: "22 servicios, 1 clave",
    oneKeyDesc:
      "ACLED, UCDP, Finnhub, FRED, NASA FIRMS, AISStream, OpenSky y más — todo activo, sin registros separados.",
  ...
  c = {
    ...
    critical: "Crítico",
    criticalText:
      "Interferencia GPS en 3 zonas bálticas. El patrón coincide con firmas previas de disrupción de infraestructura. Cable NordBalt + Balticconnector en el área afectada.",
    elevated: "Elevado",
    elevatedText:
      "Pakistan CII 67→74. 12 nuevos eventos de protesta (Lahore, Karachi, Islamabad). El último pico comparable precedió la crisis política de 2024.",
    watch: "Vigilancia",
    watchText:
      "Brent +2,3% por anomalía AIS en Hormuz. 4 buques fantasma en 6h. Ejercicio IRGC anunciado para la próxima semana.",
  },
  l = {
    apiTier: "PLAN API",
    title: "Inteligencia programática",
    subtitle:
      "Para desarrolladores, analistas y equipos que construyen sobre datos de World Monitor. Independiente de Pro — usa ambos o cualquiera.",
    restApi: "API REST en los 22 dominios de servicio",
    authenticated: "Autenticación por clave, límite de tasa por plan",
    structured:
      "JSON estructurado con cabeceras de caché y documentación OpenAPI 3.1",
    starter: "Starter",
    ...
    feedData:
      "Alimenta tus paneles, automatiza alertas vía Zapier/n8n/Make, construye modelos de puntuación personalizados sobre datos CII/riesgo.",
  },
  d = {
    enterpriseTier: "PLAN ENTERPRISE",
    title: "Infraestructura de inteligencia",
    subtitle:
      "Para gobiernos, instituciones, mesas de trading y organizaciones que necesitan la plataforma completa con máxima seguridad, agentes IA y profundidad de datos.",
    security: "Seguridad de grado gubernamental",
    securityDesc:
      "Despliegue air-gapped, Docker on-premises, tenant cloud dedicado, ruta SOC 2 Type II, SSO/MFA y auditoría completa.",
    aiAgents: "Agentes IA & MCP",
    aiAgentsDesc:
      "Agentes de inteligencia autónomos con personas de inversor. Conecta World Monitor como herramienta a Claude, GPT o LLMs personalizados vía MCP.",
    dataLayers: "Capas de datos ampliadas",
    dataLayersDesc:
      "Decenas de miles de activos de infraestructura mapeados globalmente. Integración de imágenes satelitales con detección de cambios y SAR.",
    connectors: "100+ conectores de datos",
    connectorsDesc:
      "PostgreSQL, Snowflake, Splunk, Sentinel, Jira, Slack, Teams y más. Exportación a PDF, PowerPoint, CSV, GeoJSON.",
    whiteLabel: "Marca blanca & Embebible",
    whiteLabelDesc:
      "Tu marca, tu dominio, tu app de escritorio. Paneles iframe embebibles para muros SOC y salas de trading.",
    financial: "Inteligencia financiera",
    financialDesc:
      "Calendario de resultados, datos de red energética, seguimiento avanzado de materias primas con inferencia de carga, screening de sanciones con correlación AIS.",
    commodity: "Trading de materias primas",
    commodityDesc:
      "Seguimiento de buques + inferencia de carga + grafo de cadena de suministro. Saber antes de que el mercado se mueva.",
    government: "Gobiernos & Instituciones",
    governmentDesc:
      "Air-gapped, agentes IA, conciencia situacional completa, MCP. Ningún dato sale de tu red.",
    risk: "Consultoras de riesgo",
    riskDesc:
      "Simulación de escenarios, personas de inversor, informes PDF/PowerPoint personalizados bajo demanda.",
    soc: "SOCs & CERT",
    socDesc:
      "Capa de amenazas cibernéticas, integración SIEM, monitoreo de anomalías BGP, feeds de ransomware.",
  ...
  f = {
    ...
    shareHint:
      "Comparte tu enlace para avanzar en la cola. Cada amigo que se une te acerca al frente.",
    copied: "¡Copiado!",
    ...
    telegram: "Telegram",
    shareText:
      "Acabo de unirme a la lista de espera de World Monitor Pro — inteligencia global en tiempo real impulsada por IA. Únete:",
