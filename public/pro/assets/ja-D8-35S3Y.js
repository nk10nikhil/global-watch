const e = {
  ...
  r = {
    ...
    signalWord: "シグナル",
    valueProps:
      "AIによる株式リサーチ、地政学分析、マクロインテリジェンス — リアルタイムで相関分析。",
  ...
  t = {
    ...
    description:
      "3D WebGL グローブ · 45以上のインタラクティブマップレイヤー · リアルタイム地政学・マーケット・エネルギー・インフラデータ",
  },
  a = {
    ...
    quote:
      "ニュースの読み解きが本当に難しくなりました。イラン、トランプの政策判断、金融市場、重要鉱物資源、あらゆる方向からの緊張が同時に高まっている。これらの事件がリアルタイムでどう関連しているかを見せてくれるツールが必要でした。",
    ceo: "CEO、",
    asToldTo: "インタビュー：",
  },
  s = {
    ...
    subtitle:
      "22のサービスドメインを同時に取得。すべて正規化・ジオコーディングされ、数千のマーカーと共にWebGLグローブ上に表示されます。",
    geopolitical: "地政学イベント",
    geopoliticalDesc:
      "ACLED・UCDP イベント（エスカレーションスコアリングとトレンド分析付き）",
    aviation: "航空トラッキング",
  ...
  n = {
    ...
    title: "眠らないAIアナリスト",
    subtitle:
      "無料ダッシュボードは世界を見せます。Proはそれが何を意味するかを教え、重要なことを見逃さないようにします。",
    nearRealTime: "準リアルタイムデータ",
    nearRealTimeDesc:
      "更新間隔が5〜15分から60秒以内に短縮。アラート専用の優先パイプライン。",
    soWhat: "「だから何？」分析",
    soWhatDesc: "影響チェーン、パターン認識、収束検出、市場-地政学相関分析。",
    orbitalSurveillance: "軌道監視分析",
    orbitalSurveillanceDesc:
      "上空通過予測、再訪頻度分析、撮影ウィンドウアラート。偵察衛星がいつあなたの関心領域を監視しているかを把握。",
    morningBriefs: "モーニングブリーフ＆フラッシュアラート",
    morningBriefsDesc:
      "AI が一晩の動向をあなたの関心分野に基づいてランク付け。速報イベントはリアルタイムでプッシュ。",
    alerting: "カスタマイズ可能なアラート",
    alertingDesc:
      "CII 変動、収束イベント、保存地点への近接、マーケット相関トリガーのルールを設定。",
    oneKey: "22サービス、キー1つ",
    oneKeyDesc:
      "ACLED、UCDP、Finnhub、FRED、NASA FIRMS、AISStream、OpenSky など — すべてアクティブ、個別登録不要。",
  ...
  l = {
    ...
    critical: "クリティカル",
    criticalText:
      "バルト海3ゾーンでGPSジャミング。パターンは過去のインフラ障害シグネチャと一致。NordBaltケーブル + Balticconnectorが影響エリア内。",
    elevated: "警戒",
    elevatedText:
      "パキスタン CII 67→74。新規抗議イベント12件（ラホール、カラチ、イスラマバード）。前回の同様の急上昇は2024年の政治危機に先行。",
    watch: "監視",
    watchText:
      "ブレント原油 +2.3%、ホルムズ海峡のAIS異常を受けて。6時間で暗船4隻。IRGC が来週の演習を発表。",
  },
  c = {
    apiTier: "API ティア",
    title: "プログラマティックインテリジェンス",
    subtitle:
      "World Monitor データを活用する開発者、アナリスト、チーム向け。Proとは独立 — 両方または片方を利用可能。",
    ...
    feedData:
      "ダッシュボードにデータを接続し、Zapier/n8n/Make でアラートを自動化、CII/リスクデータでカスタムスコアリングモデルを構築。",
  },
  d = {
    enterpriseTier: "エンタープライズティア",
    title: "インテリジェンスインフラ",
    subtitle:
      "政府、機関、トレーディングデスク、最高レベルのセキュリティ、AIエージェント、データの深さを必要とする組織向けの完全なプラットフォーム。",
    security: "政府レベルのセキュリティ",
    securityDesc:
      "エアギャップ展開、オンプレミス Docker、専用クラウドテナント、SOC 2 Type II パス、SSO/MFA、完全な監査証跡。",
    aiAgents: "AIエージェント＆MCP",
    aiAgentsDesc:
      "投資家ペルソナを持つ自律型インテリジェンスエージェント。MCP経由でWorld MonitorをClaude、GPT、カスタムLLMのツールとして接続。",
    dataLayers: "拡張データレイヤー",
    dataLayersDesc:
      "数万のインフラ資産をグローバルにマッピング。変化検出とSARを備えた衛星画像統合。",
    connectors: "100以上のデータコネクタ",
    connectorsDesc:
      "PostgreSQL、Snowflake、Splunk、Sentinel、Jira、Slack、Teams など。PDF、PowerPoint、CSV、GeoJSON へのエクスポート。",
    whiteLabel: "ホワイトラベル＆埋め込み対応",
    whiteLabelDesc:
      "あなたのブランド、ドメイン、デスクトップアプリ。SOCウォールやトレーディングフロア向けの埋め込みiframeパネル。",
    financial: "金融インテリジェンス",
    financialDesc:
      "決算カレンダー、エネルギーグリッドデータ、カーゴ推定付き強化コモディティトラッキング、AIS相関付き制裁スクリーニング。",
    commodity: "コモディティトレーディング",
    commodityDesc:
      "船舶追跡 + カーゴ推定 + サプライチェーングラフ。市場が動く前に把握。",
    government: "政府・機関",
    governmentDesc:
      "エアギャップ、AIエージェント、完全な状況認識、MCP。データはネットワーク外に出ません。",
    risk: "リスクコンサルティング",
    riskDesc:
      "シナリオシミュレーション、投資家ペルソナ、ブランド付きPDF/PowerPointレポートをオンデマンドで。",
    soc: "SOCs・CERT",
    socDesc:
      "サイバー脅威レイヤー、SIEM統合、BGP異常モニタリング、ランサムウェアフィード。",
    orgPlaceholder: "会社名 *",
  ...
  P = {
    ...
    shareHint:
      "リンクをシェアして順位を上げましょう。友達が参加するたびに、あなたの順番が繰り上がります。",
    copied: "コピーしました！",
    shareOnX: "Xでシェア",
    linkedin: "LinkedIn",
    whatsapp: "WhatsApp",
    telegram: "Telegram",
    shareText:
      "World Monitor Pro のウェイトリストに登録しました — AIが駆動するリアルタイムグローバルインテリジェンス。一緒に参加しよう：",
