const n = {
  ...
  t = {
    ...
    signalWord: "Tín hiệu",
    valueProps:
      "Nghiên cứu cổ phiếu bằng AI, phân tích địa chính trị và tình báo kinh tế vĩ mô — tương quan theo thời gian thực.",
  ...
  i = { asFeaturedIn: "Được giới thiệu trên" },
  h = {
    ...
    description:
      "Quả địa cầu 3D WebGL · Hơn 45+ lớp bản đồ tương tác · Dữ liệu địa chính trị, thị trường, năng lượng và cơ sở hạ tầng thời gian thực",
  },
  e = {
    ...
    quote:
      "Tin tức thực sự trở nên khó phân tích. Iran, các quyết định của Trump, thị trường tài chính, khoáng sản quan trọng, căng thẳng dồn dập từ mọi hướng cùng lúc. Tôi cần một thứ cho thấy các sự kiện này kết nối với nhau như thế nào trong thời gian thực.",
    ceo: "CEO của",
  ...
  c = {
    ...
    subtitle:
      "22 miền dịch vụ được thu thập đồng thời. Tất cả được chuẩn hóa, định vị địa lý và hiển thị trên quả địa cầu WebGL với hàng nghìn điểm đánh dấu.",
    geopolitical: "Sự kiện địa chính trị",
    geopoliticalDesc:
      "Sự kiện ACLED & UCDP với chấm điểm leo thang và phân tích xu hướng",
    ...
    marketsDesc:
      "Cổ phiếu, hàng hóa, tiền mã hóa, dòng ETF, dữ liệu vĩ mô FRED",
    cyber: "Mối đe dọa mạng",
    cyberDesc: "Nguồn cấp ransomware, chiếm đoạt BGP, phát hiện DDoS",
    gdelt: "GDELT & Tin tức",
    gdeltDesc:
      "Hơn 435+ kênh RSS, sự kiện GDELT được AI chấm điểm, phát sóng trực tiếp",
  ...
  r = {
    ...
    subtitle:
      "Bảng điều khiển miễn phí cho bạn thấy thế giới. Pro cho bạn biết ý nghĩa của nó — và đảm bảo bạn không bỏ lỡ điều quan trọng.",
    nearRealTime: "Dữ liệu gần thời gian thực",
    nearRealTimeDesc:
      "Tốc độ làm mới tăng từ 5-15 phút xuống dưới 60 giây. Pipeline ưu tiên cho cảnh báo của bạn.",
    soWhat: 'Phân tích "Vậy thì sao?"',
    soWhatDesc:
      "Chuỗi tác động, nhận dạng mô hình, phát hiện hội tụ và tương quan thị trường-địa chính trị.",
    orbitalSurveillance: "Phân tích giám sát quỹ đạo",
    orbitalSurveillanceDesc:
      "Dự đoán bay qua, phân tích tần suất quay lại và cảnh báo cửa sổ chụp ảnh. Biết khi nào vệ tinh tình báo đang theo dõi khu vực quan tâm của bạn.",
    morningBriefs: "Tóm tắt buổi sáng & Cảnh báo nhanh",
    morningBriefsDesc:
      "AI tổng hợp diễn biến qua đêm, xếp hạng theo lĩnh vực bạn quan tâm. Sự kiện nóng được gửi ngay thời gian thực.",
    alerting: "Cảnh báo tùy chỉnh",
    alertingDesc:
      "Đặt quy tắc cho biến động CII, sự kiện hội tụ, khoảng cách đến vị trí đã lưu và kích hoạt tương quan thị trường.",
    oneKey: "22 dịch vụ, 1 khóa",
    oneKeyDesc:
      "ACLED, UCDP, Finnhub, FRED, NASA FIRMS, AISStream, OpenSky và nhiều hơn — tất cả đều hoạt động, không cần đăng ký riêng.",
  ...
  g = {
    ...
    criticalText:
      "Nhiễu GPS tại 3 vùng Baltic. Mô hình trùng khớp với dấu hiệu gián đoạn hạ tầng trước đó. Cáp NordBalt + Balticconnector nằm trong khu vực bị ảnh hưởng.",
    elevated: "Nâng cao",
    elevatedText:
      "Pakistan CII 67→74. 12 sự kiện biểu tình mới (Lahore, Karachi, Islamabad). Đợt tăng tương tự gần nhất xảy ra trước khủng hoảng chính trị 2024.",
    watch: "Theo dõi",
    watchText:
      "Brent +2.3% do bất thường AIS tại eo biển Hormuz. 4 tàu tối trong 6 giờ. Cuộc tập trận IRGC được công bố tuần tới.",
  },
  o = {
    apiTier: "GÓI API",
    title: "Tình báo lập trình",
    subtitle:
      "Dành cho nhà phát triển, nhà phân tích và các nhóm xây dựng trên dữ liệu World Monitor. Độc lập với Pro — dùng cả hai hoặc một trong hai.",
    ...
    feedData:
      "Đưa dữ liệu vào bảng điều khiển của bạn, tự động hóa cảnh báo qua Zapier/n8n/Make, xây dựng mô hình chấm điểm tùy chỉnh trên dữ liệu CII/rủi ro.",
  },
  s = {
    enterpriseTier: "GÓI ENTERPRISE",
    title: "Hạ tầng tình báo",
    subtitle:
      "Dành cho chính phủ, tổ chức, bàn giao dịch và các tổ chức cần nền tảng đầy đủ với bảo mật tối đa, AI agents và chiều sâu dữ liệu.",
    security: "Bảo mật cấp chính phủ",
    securityDesc:
      "Triển khai air-gapped, Docker on-premises, cloud tenant chuyên dụng, lộ trình SOC 2 Type II, SSO/MFA và nhật ký kiểm toán đầy đủ.",
    aiAgents: "AI Agents & MCP",
    aiAgentsDesc:
      "Agents tình báo tự chủ với hồ sơ nhà đầu tư. Kết nối World Monitor như một công cụ với Claude, GPT hoặc LLM tùy chỉnh qua MCP.",
    dataLayers: "Lớp dữ liệu mở rộng",
    dataLayersDesc:
      "Hàng chục nghìn tài sản hạ tầng được ánh xạ toàn cầu. Tích hợp ảnh vệ tinh với phát hiện thay đổi và SAR.",
    connectors: "Hơn 100+ đầu nối dữ liệu",
    connectorsDesc:
      "PostgreSQL, Snowflake, Splunk, Sentinel, Jira, Slack, Teams và nhiều hơn. Xuất sang PDF, PowerPoint, CSV, GeoJSON.",
    whiteLabel: "White-label & Nhúng được",
    whiteLabelDesc:
      "Thương hiệu của bạn, tên miền của bạn, ứng dụng desktop của bạn. Bảng iframe nhúng được cho tường SOC và sàn giao dịch.",
    financial: "Tình báo tài chính",
    financialDesc:
      "Lịch công bố lợi nhuận, dữ liệu lưới năng lượng, theo dõi hàng hóa nâng cao với suy luận hàng hóa, sàng lọc trừng phạt với tương quan AIS.",
    commodity: "Giao dịch hàng hóa",
    commodityDesc:
      "Theo dõi tàu + suy luận hàng hóa + đồ thị chuỗi cung ứng. Biết trước khi thị trường biến động.",
    government: "Chính phủ & Tổ chức",
    governmentDesc:
      "Air-gapped, AI agents, nhận thức tình huống toàn diện, MCP. Không có dữ liệu nào rời khỏi mạng của bạn.",
    risk: "Tư vấn rủi ro",
    riskDesc:
      "Mô phỏng kịch bản, hồ sơ nhà đầu tư, báo cáo PDF/PowerPoint có thương hiệu theo yêu cầu.",
    soc: "SOC & CERT",
    socDesc:
      "Lớp mối đe dọa mạng, tích hợp SIEM, giám sát bất thường BGP, nguồn cấp ransomware.",
  ...
  d = {
    ...
    shareHint:
      "Chia sẻ liên kết để tiến lên trong hàng chờ. Mỗi người bạn tham gia sẽ đẩy bạn gần hơn đến vị trí đầu.",
    copied: "Đã sao chép!",
    ...
    telegram: "Telegram",
    shareText:
      "Tôi vừa tham gia danh sách chờ World Monitor Pro — tình báo toàn cầu thời gian thực được hỗ trợ bởi AI. Tham gia cùng tôi:",
