const e = {
  ...
  i = {
    ...
    signalWord: "Semnal",
    valueProps:
      "Cercetare de acțiuni alimentată de AI, analiză geopolitică și informații macroeconomice — corelate în timp real.",
  ...
  a = { asFeaturedIn: "Așa cum a apărut în" },
  r = {
    ...
    description:
      "Glob 3D WebGL · 45+ straturi interactive de hartă · Date geopolitice, de piață, energetice și de infrastructură în timp real",
  },
  t = {
    ...
    quote:
      "Știrile au devenit cu adevărat greu de descifrat. Iran, deciziile lui Trump, piețele financiare, mineralele critice, tensiuni care se acumulau din toate direcțiile simultan. Aveam nevoie de ceva care să-mi arate cum se conectează aceste evenimente între ele în timp real.",
    ceo: "CEO al",
  ...
  n = {
    ...
    subtitle:
      "22 domenii de servicii ingerate simultan. Totul normalizat, geolocalizat și redat pe un glob WebGL cu mii de marcatori.",
    geopolitical: "Evenimente geopolitice",
    geopoliticalDesc:
      "Evenimente ACLED și UCDP cu scor de escaladare și analiză de tendințe",
    aviation: "Urmărire aviație",
    aviationDesc: "Urmărire transponder ADS-B a modelelor globale de zbor",
    maritime: "Maritim și AIS",
    maritimeDesc:
      "Mișcări de nave, detectare de nave, activitate portuară și comercială",
    fire: "Detectare incendii prin satelit",
    fireDesc:
      "Date NASA FIRMS privind incendii și puncte fierbinți în timp aproape real",
    ...
    gdeltDesc:
      "435+ fluxuri RSS, evenimente GDELT evaluate de AI, transmisii live",
    unrest: "Tulburări civile și strămutare",
    unrestDesc:
      "Proteste, fluxuri de refugiați, date UNHCR privind strămutarea",
    seismology: "Seismologie și natură",
    seismologyDesc:
      "Cutremure USGS, activitate vulcanică, fenomene meteorologice severe",
  },
  o = {
    free: "Gratuit",
  ...
  l = {
    ...
    subtitle:
      "Panoul gratuit îți arată lumea. Pro îți spune ce înseamnă — și se asigură că nu ratezi niciodată ce contează.",
    nearRealTime: "Date aproape în timp real",
    nearRealTimeDesc:
      "Actualizare accelerată de la 5-15 min la sub 60 de secunde. Pipeline prioritar pentru alertele tale.",
    soWhat: 'Analiză „Și ce-nseamnă asta?"',
    soWhatDesc:
      "Lanțuri de impact, recunoaștere de tipare, detectare de convergență și corelație piață-geopolitică.",
    orbitalSurveillance: "Analiză de supraveghere orbitală",
    orbitalSurveillanceDesc:
      "Predicții de trecere, analiză a frecvenței de revizitare și alerte pentru ferestre de imagistică. Aflați când sateliții de informații vă observă zonele de interes.",
    morningBriefs: "Briefinguri de dimineață și alerte flash",
    morningBriefsDesc:
      "Evoluții nocturne sintetizate de AI, clasate după domeniile tale de interes. Evenimentele de ultimă oră livrate în timp real.",
    alerting: "Alerte configurabile",
    alertingDesc:
      "Setează reguli pentru deltele CII, evenimente de convergență, proximitate față de locații salvate și declanșatoare de corelație de piață.",
    oneKey: "22 servicii, 1 cheie",
    oneKeyDesc:
      "ACLED, UCDP, Finnhub, FRED, NASA FIRMS, AISStream, OpenSky și altele — toate active, fără înregistrări separate.",
  ...
  c = {
    ...
    critical: "Critic",
    criticalText:
      "Bruiaj GPS în 3 zone baltice. Tiparul corespunde semnăturilor anterioare de perturbare a infrastructurii. Cablul NordBalt + Balticconnector în zona afectată.",
    elevated: "Ridicat",
    elevatedText:
      "Pakistan CII 67→74. 12 noi evenimente de protest (Lahore, Karachi, Islamabad). Ultimul vârf comparabil a precedat criza politică din 2024.",
    watch: "Monitorizare",
    watchText:
      "Brent +2,3% pe anomalia AIS Hormuz. 4 nave întunecate în 6 ore. Exercițiu IRGC anunțat săptămâna viitoare.",
  },
  s = {
    apiTier: "API TIER",
    title: "Informații programatice",
    subtitle:
      "Pentru dezvoltatori, analiști și echipe care construiesc pe datele World Monitor. Separat de Pro — folosește ambele sau oricare.",
    restApi: "REST API pentru toate cele 22 domenii de servicii",
    authenticated: "Autentificat per cheie, limitat per tier",
    structured:
      "JSON structurat cu headere de cache și documentație OpenAPI 3.1",
    starter: "Starter",
    ...
    feedData:
      "Alimentează date în panourile tale, automatizează alertele prin Zapier/n8n/Make, construiește modele de scoring personalizate pe date CII/risc.",
  },
  u = {
    enterpriseTier: "ENTERPRISE TIER",
    title: "Infrastructură de informații",
    subtitle:
      "Pentru guverne, instituții, desk-uri de tranzacționare și organizații care au nevoie de platforma completă cu securitate maximă, agenți AI și profunzime a datelor.",
    security: "Securitate de nivel guvernamental",
    securityDesc:
      "Implementare air-gapped, Docker on-premises, tenant cloud dedicat, traiect SOC 2 Type II, SSO/MFA și jurnal de audit complet.",
    aiAgents: "Agenți AI și MCP",
    aiAgentsDesc:
      "Agenți de informații autonomi cu profiluri de investitori. Conectează World Monitor ca instrument la Claude, GPT sau LLM-uri personalizate prin MCP.",
    dataLayers: "Straturi de date extinse",
    dataLayersDesc:
      "Zeci de mii de active de infrastructură cartografiate global. Integrare imagini satelitare cu detectare de schimbări și SAR.",
    connectors: "100+ conectori de date",
    connectorsDesc:
      "PostgreSQL, Snowflake, Splunk, Sentinel, Jira, Slack, Teams și altele. Export în PDF, PowerPoint, CSV, GeoJSON.",
    whiteLabel: "White-label și integrabil",
    whiteLabelDesc:
      "Brandul tău, domeniul tău, aplicația ta desktop. Panouri iframe integrabile pentru pereții SOC și sălile de tranzacționare.",
    financial: "Informații financiare",
    financialDesc:
      "Calendar de rezultate, date rețele energetice, urmărire extinsă a mărfurilor cu inferență de cargo, screening sancțiuni cu corelație AIS.",
    commodity: "Tranzacționare mărfuri",
    commodityDesc:
      "Urmărire nave + inferență cargo + graf lanț de aprovizionare. Știi înainte ca piața să se miște.",
    government: "Guverne și instituții",
    governmentDesc:
      "Air-gapped, agenți AI, conștiință situațională completă, MCP. Nicio dată nu părăsește rețeaua ta.",
    risk: "Consultanțe de risc",
    riskDesc:
      "Simulare scenarii, profiluri de investitori, rapoarte PDF/PowerPoint de brand la cerere.",
    soc: "SOCs și CERT",
    socDesc:
      "Strat de amenințări cibernetice, integrare SIEM, monitorizare anomalii BGP, fluxuri ransomware.",
  ...
  g = {
    ...
    shareHint:
      "Distribuie linkul tău pentru a avansa în rând. Fiecare prieten care se alătură te mută mai aproape de față.",
    copied: "Copiat!",
    ...
    telegram: "Telegram",
    shareText:
      "Tocmai m-am înscris pe lista de așteptare World Monitor Pro — informații globale în timp real alimentate de AI. Alătură-te:",
