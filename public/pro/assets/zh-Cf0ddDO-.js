const e = {
  ...
  t = {
    ...
    description:
      "3D WebGL 地球 · 45+ 交互式地图图层 · 实时地缘政治、市场、能源和基础设施数据",
  },
  a = {
    uniqueVisitors: "独立访客",
    ...
    quote:
      "新闻变得极其难以解读。伊朗、特朗普的决策、金融市场、关键矿产，紧张局势从四面八方同时涌来。我需要一个工具，让我实时看到这些事件之间的关联。",
    ceo: "CEO，",
    asToldTo: "接受采访于",
  },
  s = {
    ...
    subtitle:
      "22 个服务域同步采集。所有数据标准化、地理编码，并在 WebGL 地球上以数千个标记呈现。",
    geopolitical: "地缘政治事件",
  ...
  n = {
    ...
    subtitle:
      "免费仪表盘让你看到世界。Pro 告诉你这意味着什么 — 确保你不会错过重要信息。",
    nearRealTime: "近实时数据",
    nearRealTimeDesc:
      "刷新速度从 5-15 分钟提升至 60 秒以内。警报专属优先通道。",
    soWhat: '"所以呢？"分析',
    soWhatDesc: "影响链、模式识别、收敛检测、市场-地缘政治关联。",
    orbitalSurveillance: "轨道监视分析",
    orbitalSurveillanceDesc:
      "过境预测、重访频率分析和成像窗口预警。了解情报卫星何时在监视您的关注区域。",
    morningBriefs: "早间简报与即时警报",
    morningBriefsDesc:
      "AI 合成隔夜动态，按你的关注领域排序。突发事件实时推送。",
    alerting: "可配置的警报",
    alertingDesc:
      "为 CII 变化、收敛事件、保存地点的临近度和市场关联触发器设置规则。",
    oneKey: "22 项服务，1 个密钥",
    oneKeyDesc:
      "ACLED、UCDP、Finnhub、FRED、NASA FIRMS、AISStream、OpenSky 等 — 全部激活，无需单独注册。",
  ...
  l = {
    ...
    critical: "危急",
    criticalText:
      "3 个波罗的海区域出现 GPS 干扰。模式匹配先前基础设施破坏特征。NordBalt 电缆 + Balticconnector 位于受影响区域。",
    elevated: "升级",
    elevatedText:
      "巴基斯坦 CII 67→74。12 起新抗议事件（拉合尔、卡拉奇、伊斯兰堡）。上次类似激增先于 2024 年政治危机。",
    watch: "关注",
    watchText:
      "布伦特原油 +2.3%，因霍尔木兹海峡 AIS 异常。6 小时内 4 艘暗船。IRGC 宣布下周演习。",
  },
  c = {
    apiTier: "API 版",
    title: "程序化情报",
    subtitle:
      "面向开发者、分析师和基于 World Monitor 数据构建的团队。独立于 Pro — 可同时使用或单独使用。",
    ...
    feedData:
      "将数据接入你的仪表盘，通过 Zapier/n8n/Make 自动化警报，基于 CII/风险数据构建自定义评分模型。",
  },
  d = {
    enterpriseTier: "企业版",
    title: "情报基础设施",
    subtitle:
      "面向政府、机构、交易台和需要完整平台的组织，提供最高级别安全性、AI 代理和数据深度。",
    security: "政府级安全",
    securityDesc:
      "气隙部署、本地 Docker、专属云租户、SOC 2 Type II 路径、SSO/MFA 和完整审计追踪。",
    aiAgents: "AI 代理与 MCP",
    aiAgentsDesc:
      "自主情报代理，含投资者画像。通过 MCP 将 World Monitor 作为工具连接到 Claude、GPT 或自定义 LLM。",
    dataLayers: "扩展数据图层",
    dataLayersDesc:
      "数万个基础设施资产全球标注。卫星影像集成，含变化检测和 SAR。",
    connectors: "100+ 数据连接器",
    connectorsDesc:
      "PostgreSQL、Snowflake、Splunk、Sentinel、Jira、Slack、Teams 等。导出为 PDF、PowerPoint、CSV、GeoJSON。",
    whiteLabel: "白标与可嵌入",
    whiteLabelDesc:
      "你的品牌、你的域名、你的桌面应用。可嵌入 iframe 面板，适用于 SOC 监控墙和交易大厅。",
    financial: "金融情报",
    financialDesc:
      "财报日历、能源电网数据、增强大宗商品追踪（含货物推断）、制裁筛查与 AIS 关联。",
    commodity: "大宗商品交易",
    commodityDesc: "船舶追踪 + 货物推断 + 供应链图谱。在市场波动前获悉信息。",
    government: "政府与机构",
    governmentDesc:
      "气隙部署、AI 代理、全面态势感知、MCP。数据不离开你的网络。",
    risk: "风险咨询",
  ...
  P = {
    ...
    telegram: "Telegram",
    shareText:
      "我刚加入了 World Monitor Pro 等候名单 — AI 驱动的全球实时情报。快来加入：",
