const e = {
  ...
  r = {
    ...
    signalWord: "Signal",
    valueProps:
      "AI-driven aktieanalys, geopolitisk analys och makrounderrättelser — korrelerade i realtid.",
  ...
  n = {
    ...
    description:
      "3D WebGL-glob · 45+ interaktiva kartlager · Geopolitisk, marknads-, energi- och infrastrukturdata i realtid",
  },
  t = {
    ...
    quote:
      "Nyheterna blev genuint svåra att tolka. Iran, Trumps beslut, finansmarknader, kritiska mineraler, spänningar som eskalerade från alla håll samtidigt. Jag behövde något som visade hur dessa händelser hänger ihop i realtid.",
    ceo: "VD för",
  ...
  i = {
    ...
    subtitle:
      "22 tjänstedomäner inhämtas simultant. Allt normaliserat, geolokaliserat och renderat på en WebGL-glob med tusentals markörer.",
    geopolitical: "Geopolitiska händelser",
    geopoliticalDesc:
      "ACLED- & UCDP-händelser med eskaleringspoäng och trendanalys",
    aviation: "Flygspårning",
    aviationDesc: "ADS-B-transponderspårning av globala flygmönster",
    maritime: "Sjöfart & AIS",
    maritimeDesc:
      "Fartygsrörelser, fartygsdetektion, hamn- och handelsaktivitet",
  ...
  l = {
    ...
    subtitle:
      "Den gratis instrumentpanelen visar dig världen. Pro berättar vad det betyder — och ser till att du aldrig missar det som spelar roll.",
    nearRealTime: "Data i nära realtid",
    nearRealTimeDesc:
      "Uppdatering accelererad från 5-15 min till under 60 sekunder. Prioriterad pipeline för dina varningar.",
    soWhat: '"Vad innebär det?"-analys',
    soWhatDesc:
      "Påverkanskedjor, mönsterigenkänning, konvergensdetektering och marknads-geopolitisk korrelation.",
    orbitalSurveillance: "Orbital övervakningsanalys",
    orbitalSurveillanceDesc:
      "Överflygningsprognoser, revisitfrekvensanalys och bildtagningsfönstervarningar. Vet när underrättelsesatelliter övervakar dina intresseområden.",
    morningBriefs: "Morgonbriefingar & blixtvarningar",
    morningBriefsDesc:
      "AI-sammanställda nattliga utvecklingar rangordnade efter dina fokusområden. Akuta händelser pushas i realtid.",
    alerting: "Konfigurerbara varningar",
    alertingDesc:
      "Sätt regler för CII-deltan, konvergenshändelser, närhet till sparade platser och marknadskorrelationstriggers.",
    oneKey: "22 tjänster, 1 nyckel",
    oneKeyDesc:
      "ACLED, UCDP, Finnhub, FRED, NASA FIRMS, AISStream, OpenSky och mer — allt aktivt, inga separata registreringar.",
  ...
  o = {
    ...
    critical: "Kritiskt",
    criticalText:
      "GPS-störning i 3 baltiska zoner. Mönstret matchar tidigare infrastrukturstörningssignaturer. NordBalt-kabeln + Balticconnector i drabbat område.",
    elevated: "Förhöjt",
    elevatedText:
      "Pakistan CII 67→74. 12 nya protesthändelser (Lahore, Karachi, Islamabad). Senaste jämförbara toppen föregick politiska krisen 2024.",
    watch: "Bevakning",
    watchText:
      "Brent +2,3% på Hormuz AIS-anomali. 4 mörka fartyg på 6 timmar. IRGC-övning aviserad nästa vecka.",
  },
  d = {
    apiTier: "API TIER",
    title: "Programmatisk underrättelse",
    subtitle:
      "För utvecklare, analytiker och team som bygger på World Monitor-data. Separat från Pro — använd båda eller endera.",
    restApi: "REST API för alla 22 tjänstedomäner",
    authenticated: "Autentiserad per nyckel, hastighetsbegränsad per tier",
    structured:
      "Strukturerad JSON med cache-headers och OpenAPI 3.1-dokumentation",
    starter: "Starter",
    ...
    feedData:
      "Mata data till dina dashboards, automatisera varningar via Zapier/n8n/Make, bygg anpassade poängmodeller på CII/riskdata.",
  },
  g = {
    enterpriseTier: "ENTERPRISE TIER",
    title: "Underrättelseinfrastruktur",
    subtitle:
      "För myndigheter, institutioner, tradingdeskar och organisationer som behöver hela plattformen med maximal säkerhet, AI-agenter och datadjup.",
    security: "Säkerhet på myndighetsnivå",
    securityDesc:
      "Air-gapped deployment, on-premises Docker, dedikerad molnklient, SOC 2 Type II-spår, SSO/MFA och fullständig granskningslogg.",
    aiAgents: "AI-agenter & MCP",
    aiAgentsDesc:
      "Autonoma underrättelseagenter med investerarprofiler. Anslut World Monitor som verktyg till Claude, GPT eller anpassade LLMs via MCP.",
    dataLayers: "Utökade datalager",
    dataLayersDesc:
      "Tiotusentals infrastrukturtillgångar kartlagda globalt. Satellitbildsintegration med förändringsdetektering och SAR.",
    connectors: "100+ datakopplingar",
    connectorsDesc:
      "PostgreSQL, Snowflake, Splunk, Sentinel, Jira, Slack, Teams och mer. Exportera till PDF, PowerPoint, CSV, GeoJSON.",
    whiteLabel: "White-label & inbäddningsbar",
    whiteLabelDesc:
      "Ditt varumärke, din domän, din skrivbordsapp. Inbäddningsbara iframe-paneler för SOC-väggar och tradingfloor.",
    financial: "Finansiell underrättelse",
    financialDesc:
      "Resultatkalender, elnätsdata, utökad råvaruspårning med lastinferens, sanktionsscreening med AIS-korrelation.",
    commodity: "Råvaruhandel",
    commodityDesc:
      "Fartygsspårning + lastinferens + leveranskedjegrafer. Vet innan marknaden rör sig.",
    government: "Myndigheter & institutioner",
    governmentDesc:
      "Air-gapped, AI-agenter, fullständig situationsmedvetenhet, MCP. Ingen data lämnar ditt nätverk.",
    risk: "Riskkonsulter",
    riskDesc:
      "Scenariosimulering, investerarprofiler, varumärkta PDF/PowerPoint-rapporter på begäran.",
    soc: "SOCs & CERT",
    socDesc:
      "Cyberhotslager, SIEM-integration, BGP-anomaliövervakning, ransomware-flöden.",
  ...
  f = {
    ...
    shareHint:
      "Dela din länk för att flytta uppåt i kön. Varje vän som ansluter sig flyttar dig närmare fronten.",
    copied: "Kopierat!",
    shareOnX: "Dela på X",
    linkedin: "LinkedIn",
    whatsapp: "WhatsApp",
    telegram: "Telegram",
    shareText:
      "Jag har precis gått med i World Monitor Pro-väntelistan — global underrättelse i realtid driven av AI. Häng med:",
