const e = {
  ...
  a = {
    ...
    signalWord: "Sinyal",
    valueProps:
      "AI destekli hisse senedi araştırması, jeopolitik analiz ve makro istihbarat — gerçek zamanlı korelasyon.",
  ...
  i = { asFeaturedIn: "Yayınlandığı yer" },
  r = {
    ...
    description:
      "3D WebGL küre · 45+ etkileşimli harita katmanı · Gerçek zamanlı jeopolitik, piyasa, enerji ve altyapı verileri",
  },
  l = {
    ...
    quote:
      "Haberler gerçekten analiz edilmesi zor bir hale geldi. İran, Trump'ın kararları, finansal piyasalar, kritik mineraller, her yönden aynı anda biriken gerilimler. Bu olayların birbirine nasıl bağlandığını gerçek zamanlı gösteren bir şeye ihtiyacım vardı.",
    ceo: "CEO,",
    asToldTo: "röportaj:",
  },
  n = {
    ...
    subtitle:
      "22 hizmet alanı eşzamanlı olarak işlenir. Her şey normalleştirilir, coğrafi konumlandırılır ve binlerce işaretçi ile WebGL küre üzerinde görselleştirilir.",
    geopolitical: "Jeopolitik Olaylar",
    geopoliticalDesc:
      "Tırmanma puanlaması ve trend analizi ile ACLED & UCDP olayları",
    aviation: "Havacılık Takibi",
    aviationDesc: "ADS-B transponder ile küresel uçuş rotalarının takibi",
    maritime: "Denizcilik & AIS",
    maritimeDesc:
      "Gemi hareketleri, gemi tespiti, liman ve ticaret faaliyetleri",
    fire: "Uydu Yangın Tespiti",
    fireDesc:
      "NASA FIRMS'ten neredeyse gerçek zamanlı yangın ve sıcak nokta verileri",
    ...
    marketsDesc:
      "Hisse senetleri, emtialar, kripto, ETF akışları, FRED makro verileri",
    ...
    seismologyDesc:
      "USGS depremleri, volkanik aktivite, şiddetli hava olayları",
  },
  t = {
    free: "Ücretsiz",
  ...
  s = {
    ...
    subtitle:
      "Ücretsiz panel size dünyayı gösterir. Pro, ne anlama geldiğini söyler — ve önemli olan hiçbir şeyi kaçırmamanızı sağlar.",
    nearRealTime: "Neredeyse gerçek zamanlı veriler",
    nearRealTimeDesc:
      "Yenileme 5-15 dakikadan 60 saniyenin altına hızlandırıldı. Uyarılarınız için öncelikli pipeline.",
    soWhat: '"Ne önemi var?" Analizi',
    soWhatDesc:
      "Etki zincirleri, örüntü tanıma, yakınsama tespiti ve piyasa-jeopolitik korelasyonu.",
    orbitalSurveillance: "Yörünge gözetim analizi",
    orbitalSurveillanceDesc:
      "Geçiş tahminleri, yeniden ziyaret sıklığı analizi ve görüntüleme penceresi uyarıları. İstihbarat uydularının ilgi alanlarınızı ne zaman izlediğini bilin.",
    morningBriefs: "Sabah brifingleri ve anlık uyarılar",
    morningBriefsDesc:
      "İlgi alanlarınıza göre sıralanan, AI tarafından sentezlenen gece gelişmeleri. Anlık olaylar gerçek zamanlı iletilir.",
    alerting: "Yapılandırılabilir uyarılar",
    alertingDesc:
      "CII değişimleri, yakınsama olayları, kayıtlı konumlara yakınlık ve piyasa korelasyon tetikleyicileri için kurallar belirleyin.",
    oneKey: "22 hizmet, 1 anahtar",
    oneKeyDesc:
      "ACLED, UCDP, Finnhub, FRED, NASA FIRMS, AISStream, OpenSky ve daha fazlası — hepsi aktif, ayrı kayıt gerekmez.",
  ...
  o = {
    ...
    critical: "Kritik",
    criticalText:
      "3 Baltık bölgesinde GPS karıştırma. Örüntü, önceki altyapı kesintisi imzalarıyla eşleşiyor. NordBalt kablosu + Balticconnector etkilenen alanda.",
    elevated: "Yükseltilmiş",
    elevatedText:
      "Pakistan CII 67→74. 12 yeni protesto olayı (Lahor, Karaçi, İslamabad). Son karşılaştırılabilir artış 2024 siyasi krizinin öncesindeydi.",
    watch: "İzle",
    watchText:
      "Hürmüz AIS anomalisine bağlı Brent +%2.3. 6 saatte 4 karanlık gemi. IRGC tatbikatı gelecek hafta ilan edildi.",
  },
  k = {
    apiTier: "API SEVİYESİ",
    title: "Programatik istihbarat",
    subtitle:
      "World Monitor verileri üzerine inşa eden geliştiriciler, analistler ve ekipler için. Pro'dan bağımsız — ikisini birlikte veya ayrı kullanın.",
    restApi: "22 hizmet alanının tamamında REST API",
    authenticated:
      "Anahtar bazında kimlik doğrulama, seviye bazında hız sınırı",
    structured:
      "Cache header'ları ve OpenAPI 3.1 dokümantasyonu ile yapılandırılmış JSON",
    starter: "Starter",
    ...
    feedData:
      "Panolarınıza veri besleyin, Zapier/n8n/Make ile uyarıları otomatikleştirin, CII/risk verileri üzerinde özel puanlama modelleri oluşturun.",
  },
  m = {
    enterpriseTier: "ENTERPRISE SEVİYESİ",
    title: "İstihbarat altyapısı",
    subtitle:
      "Maksimum güvenlik, AI ajanlar ve veri derinliği ile tam platformu ihtiyaç duyan hükümetler, kurumlar, trading masaları ve organizasyonlar için.",
    security: "Devlet düzeyinde güvenlik",
    securityDesc:
      "Air-gapped dağıtım, Docker on-premises, özel bulut kiracısı, SOC 2 Type II yolu, SSO/MFA ve tam denetim izi.",
    aiAgents: "AI Ajanlar & MCP",
    aiAgentsDesc:
      "Yatırımcı profilleri ile otonom istihbarat ajanları. World Monitor'ü Claude, GPT veya özel LLM'lere MCP aracılığıyla bir araç olarak bağlayın.",
    dataLayers: "Genişletilmiş veri katmanları",
    dataLayersDesc:
      "Küresel ölçekte haritalanmış on binlerce altyapı varlığı. Değişiklik tespiti ve SAR ile uydu görüntü entegrasyonu.",
    connectors: "100+ veri bağlayıcısı",
    connectorsDesc:
      "PostgreSQL, Snowflake, Splunk, Sentinel, Jira, Slack, Teams ve daha fazlası. PDF, PowerPoint, CSV, GeoJSON'a dışa aktarım.",
    whiteLabel: "White-label & Gömülebilir",
    whiteLabelDesc:
      "Sizin markanız, sizin alan adınız, sizin masaüstü uygulamanız. SOC duvarları ve trading salonları için gömülebilir iframe panelleri.",
    financial: "Finansal istihbarat",
    financialDesc:
      "Kazanç takvimi, enerji şebekesi verileri, kargo çıkarımı ile gelişmiş emtia takibi, AIS korelasyonu ile yaptırım taraması.",
    commodity: "Emtia ticareti",
    commodityDesc:
      "Gemi takibi + kargo çıkarımı + tedarik zinciri grafiği. Piyasa hareket etmeden önce bilin.",
    government: "Hükümet & Kurumlar",
    governmentDesc:
      "Air-gapped, AI ajanlar, tam durumsal farkındalık, MCP. Hiçbir veri ağınızdan çıkmaz.",
    risk: "Risk danışmanlığı",
    riskDesc:
      "Senaryo simülasyonu, yatırımcı profilleri, talep üzerine markalı PDF/PowerPoint raporları.",
    soc: "SOC & CERT",
    socDesc:
      "Siber tehdit katmanı, SIEM entegrasyonu, BGP anomali izleme, ransomware akışları.",
  ...
  p = {
    ...
    shareHint:
      "Sırada yükselmek için bağlantınızı paylaşın. Katılan her arkadaş sizi öne taşır.",
    copied: "Kopyalandı!",
    ...
    telegram: "Telegram",
    shareText:
      "World Monitor Pro bekleme listesine katıldım — AI destekli gerçek zamanlı küresel istihbarat. Siz de katılın:",
