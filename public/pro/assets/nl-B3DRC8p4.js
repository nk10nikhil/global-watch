const e = {
  ...
  i = {
    ...
    signalWord: "Signaal",
    valueProps:
      "AI-aangedreven aandelenonderzoek, geopolitieke analyse en macro-inlichtingen — in real-time gecorreleerd.",
  ...
  n = { asFeaturedIn: "Zoals verschenen in" },
  r = {
    ...
    description:
      "3D WebGL-globe · 45+ interactieve kaartlagen · Real-time geopolitieke, markt-, energie- en infrastructuurdata",
  },
  t = {
    ...
    quote:
      "Het nieuws werd echt moeilijk te volgen. Iran, Trumps beslissingen, financiële markten, kritieke grondstoffen, spanningen die zich vanuit alle richtingen tegelijk opstapelden. Ik had iets nodig dat me liet zien hoe deze gebeurtenissen in real time met elkaar verbonden zijn.",
    ceo: "CEO van",
  ...
  a = {
    ...
    subtitle:
      "22 servicedomeinen gelijktijdig verwerkt. Alles genormaliseerd, gelokaliseerd en weergegeven op een WebGL-globe met duizenden markers.",
    geopolitical: "Geopolitieke gebeurtenissen",
    geopoliticalDesc:
      "ACLED- & UCDP-gebeurtenissen met escalatiescoring en trendanalyse",
    aviation: "Luchtvaart tracking",
    aviationDesc: "ADS-B-transpondertracking van wereldwijde vluchtpatronen",
    maritime: "Maritiem & AIS",
    maritimeDesc:
      "Scheepsbewegingen, vaartuigdetectie, haven- en handelsactiviteit",
    ...
    infraDesc:
      "Nucleaire locaties, elektriciteitsnetwerken, pijpleidingen, raffinaderijen",
    ...
    gdelt: "GDELT & Nieuws",
    gdeltDesc:
      "435+ RSS-feeds, AI-gescoorde GDELT-gebeurtenissen, live uitzendingen",
  ...
  o = {
    ...
    subtitle:
      "Het gratis dashboard laat je de wereld zien. Pro vertelt je wat het betekent — en zorgt dat je nooit iets belangrijks mist.",
    nearRealTime: "Near-real-time data",
    nearRealTimeDesc:
      "Verversing versneld van 5-15 min naar minder dan 60 seconden. Prioriteitspipeline voor jouw alerts.",
    soWhat: '"En dan?"-analyse',
    soWhatDesc:
      "Impactketens, patroonherkenning, convergentiedetectie en markt-geopolitieke correlatie.",
    orbitalSurveillance: "Orbitale bewakingsanalyse",
    orbitalSurveillanceDesc:
      "Overkomstvoorspellingen, herbezoekfrequentie-analyse en imaging-venster-alerts. Weet wanneer inlichtingensatellieten uw interessegebieden observeren.",
    morningBriefs: "Ochtendbriefings & flitsalerts",
    morningBriefsDesc:
      "AI-samengestelde nachtelijke ontwikkelingen gerangschikt op jouw aandachtsgebieden. Breaking events in real-time gepusht.",
    alerting: "Configureerbare alerts",
    alertingDesc:
      "Stel regels in voor CII-delta's, convergentie-events, nabijheid van opgeslagen locaties en marktcorrelatietriggers.",
    oneKey: "22 services, 1 sleutel",
    oneKeyDesc:
      "ACLED, UCDP, Finnhub, FRED, NASA FIRMS, AISStream, OpenSky en meer — allemaal actief, geen aparte registraties.",
  ...
  l = {
    ...
    critical: "Kritiek",
    criticalText:
      "GPS-jamming in 3 Baltische zones. Patroon komt overeen met eerdere infrastructuurverstoringssignaturen. NordBalt-kabel + Balticconnector in getroffen gebied.",
    elevated: "Verhoogd",
    elevatedText:
      "Pakistan CII 67→74. 12 nieuwe protestgebeurtenissen (Lahore, Karachi, Islamabad). Laatste vergelijkbare piek ging vooraf aan politieke crisis van 2024.",
    watch: "Aandacht",
    watchText:
      "Brent +2,3% op Hormuz AIS-anomalie. 4 dark ships in 6 uur. IRGC-oefening volgende week aangekondigd.",
  },
  d = {
    apiTier: "API TIER",
    title: "Programmatische inlichtingen",
    subtitle:
      "Voor ontwikkelaars, analisten en teams die bouwen op World Monitor-data. Los van Pro — gebruik beide of een van beide.",
    restApi: "REST API voor alle 22 servicedomeinen",
    authenticated: "Per sleutel geauthenticeerd, rate-limited per tier",
    structured:
      "Gestructureerde JSON met cache-headers en OpenAPI 3.1-documentatie",
    starter: "Starter",
    ...
    feedData:
      "Voed data in jouw dashboards, automatiseer alerting via Zapier/n8n/Make, bouw custom scoringsmodellen op CII/risicodata.",
  },
  g = {
    enterpriseTier: "ENTERPRISE TIER",
    title: "Inlichtingeninfrastructuur",
    subtitle:
      "Voor overheden, instellingen, trading desks en organisaties die het volledige platform nodig hebben met maximale beveiliging, AI-agents en datadiepte.",
    security: "Overheidswaardige beveiliging",
    securityDesc:
      "Air-gapped deployment, on-premises Docker, dedicated cloud-tenant, SOC 2 Type II-traject, SSO/MFA en volledig audittrail.",
    aiAgents: "AI-agents & MCP",
    aiAgentsDesc:
      "Autonome inlichtingenagents met beleggersprofielen. Verbind World Monitor als tool met Claude, GPT of custom LLMs via MCP.",
    dataLayers: "Uitgebreide datalagen",
    dataLayersDesc:
      "Tienduizenden infrastructuurobjecten wereldwijd in kaart gebracht. Satellietbeeldintegratie met wijzigingsdetectie en SAR.",
    connectors: "100+ dataconnectoren",
    connectorsDesc:
      "PostgreSQL, Snowflake, Splunk, Sentinel, Jira, Slack, Teams en meer. Exporteer naar PDF, PowerPoint, CSV, GeoJSON.",
    whiteLabel: "White-label & inbedbaar",
    whiteLabelDesc:
      "Jouw merk, jouw domein, jouw desktop-app. Inbedbare iframe-panelen voor SOC-walls en trading floors.",
    financial: "Financiële inlichtingen",
    financialDesc:
      "Winstkalender, energienetwerkdata, uitgebreide grondstoftracking met ladingsinferentie, sanctiescreening met AIS-correlatie.",
    commodity: "Grondstoffenhandel",
    commodityDesc:
      "Scheepstracking + ladingsinferentie + supply chain-grafiek. Weet het vóór de markt beweegt.",
    government: "Overheid & instellingen",
    governmentDesc:
      "Air-gapped, AI-agents, volledig situationeel bewustzijn, MCP. Geen data verlaat je netwerk.",
    risk: "Risicoadviesbureaus",
    riskDesc:
      "Scenariosimulatie, beleggersprofielen, branded PDF/PowerPoint-rapporten op aanvraag.",
    soc: "SOCs & CERT",
    socDesc:
      "Cyberdreigingslaag, SIEM-integratie, BGP-anomaliemonitoring, ransomware-feeds.",
  ...
  k = {
    ...
    shareHint:
      "Deel je link om hogerop te komen. Elke vriend die zich aanmeldt brengt je dichter bij de voorkant.",
    copied: "Gekopieerd!",
    shareOnX: "Deel op X",
    linkedin: "LinkedIn",
    whatsapp: "WhatsApp",
    telegram: "Telegram",
    shareText:
      "Ik heb me net ingeschreven voor de World Monitor Pro-wachtlijst — real-time wereldwijde inlichtingen aangedreven door AI. Doe mee:",
