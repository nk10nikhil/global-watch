const e = {
  ...
  a = {
    ...
    signalWord: "Signál",
    valueProps:
      "Akciový výzkum poháněný AI, geopolitická analýza a makroekonomické zpravodajství — korelováno v reálném čase.",
  ...
  o = { asFeaturedIn: "Jak bylo uvedeno v" },
  n = {
    ...
    description:
      "3D WebGL glóbus · 45+ interaktivních mapových vrstev · Geopolitická, tržní, energetická a infrastrukturní data v reálném čase",
  },
  t = {
    ...
    quote:
      "Zprávy se staly opravdu těžko čitelnými. Írán, Trumpova rozhodnutí, finanční trhy, kritické suroviny, napětí narůstající ze všech stran současně. Potřeboval jsem něco, co mi ukáže, jak tyto události spolu v reálném čase souvisejí.",
    ceo: "CEO společnosti",
  ...
  r = {
    ...
    subtitle:
      "22 datových domén zpracovávaných současně. Vše normalizováno, geolokováno a vykresleno na WebGL glóbu s tisíci značkami.",
    geopolitical: "Geopolitické události",
    geopoliticalDesc:
      "Události ACLED a UCDP s hodnocením eskalace a analýzou trendů",
    aviation: "Sledování letového provozu",
    aviationDesc:
      "Sledování globálních letových tras pomocí ADS-B transponderů",
    maritime: "Námořní provoz a AIS",
    maritimeDesc:
      "Pohyby lodí, detekce plavidel, přístavní a obchodní aktivita",
  ...
  i = {
    ...
    subtitle:
      "Bezplatný dashboard vám ukazuje svět. Pro vám řekne, co to znamená — a zajistí, že vám nic důležitého neunikne.",
    nearRealTime: "Data téměř v reálném čase",
    nearRealTimeDesc:
      "Obnovení zrychleno z 5-15 min na méně než 60 sekund. Prioritní pipeline pro vaše výstrahy.",
    soWhat: "Analýza „A co to znamená?“",
    soWhatDesc:
      "Řetězce dopadů, rozpoznávání vzorců, detekce konvergence a korelace trhu s geopolitikou.",
    orbitalSurveillance: "Analýza orbitálního sledování",
    orbitalSurveillanceDesc:
      "Předpovědi přeletů, analýza frekvence návštěv a upozornění na okna pro snímkování. Vězte, kdy zpravodajské satelity sledují vaše oblasti zájmu.",
    morningBriefs: "Ranní přehledy a bleskové výstrahy",
    morningBriefsDesc:
      "AI syntetizovaný přehled nočního vývoje seřazený podle vašich prioritních oblastí. Zlomové události doručovány v reálném čase.",
    alerting: "Nastavitelné výstrahy",
    alertingDesc:
      "Nastavte pravidla pro změny CII, konvergenční události, blízkost uložených lokací a korelační spouštěče trhu.",
    oneKey: "22 služeb, 1 klíč",
    oneKeyDesc:
      "ACLED, UCDP, Finnhub, FRED, NASA FIRMS, AISStream, OpenSky a další — vše aktivní, bez samostatných registrací.",
  ...
  l = {
    ...
    critical: "Kritické",
    criticalText:
      "Rušení GPS ve 3 baltských zónách. Vzorec odpovídá předchozím signaturám narušení infrastruktury. Kabel NordBalt + Balticconnector v zasažené oblasti.",
    elevated: "Zvýšené",
    elevatedText:
      "Pakistan CII 67→74. 12 nových protestních událostí (Láhaur, Karáčí, Islámábád). Poslední srovnatelný nárůst předcházel politické krizi 2024.",
    watch: "Sledovat",
    watchText:
      "Brent +2.3 % na základě AIS anomálie v Hormuzském průlivu. 4 tmavé lodě za 6 h. Cvičení IRGC ohlášeno na příští týden.",
  },
  d = {
    apiTier: "ÚROVEŇ API",
    title: "Programový přístup ke zpravodajství",
    subtitle:
      "Pro vývojáře, analytiky a týmy stavějící na datech World Monitor. Nezávislé na Pro — použijte obojí nebo jedno z toho.",
    restApi: "REST API přes všech 22 doménových služeb",
    authenticated: "Autentizace per klíč, rate limiting dle úrovně",
    structured:
      "Strukturovaný JSON s cache hlavičkami a OpenAPI 3.1 dokumentací",
    starter: "Starter",
    ...
    feedData:
      "Napojte data do svých dashboardů, automatizujte upozornění přes Zapier/n8n/Make, vytvářejte vlastní skórovací modely na CII/rizikových datech.",
  },
  v = {
    enterpriseTier: "ÚROVEŇ ENTERPRISE",
    title: "Zpravodajská infrastruktura",
    subtitle:
      "Pro vlády, instituce, obchodní pulty a organizace, které potřebují kompletní platformu s maximálním zabezpečením, AI agenty a hloubkou dat.",
    security: "Bezpečnost na vládní úrovni",
    securityDesc:
      "Air-gapped nasazení, Docker on-premises, dedikovaný cloudový tenant, cesta k SOC 2 Type II, SSO/MFA a kompletní auditní stopa.",
    aiAgents: "AI agenti a MCP",
    aiAgentsDesc:
      "Autonomní zpravodajští agenti s investorskými personami. Připojte World Monitor jako nástroj ke Claude, GPT nebo vlastním LLM přes MCP.",
    dataLayers: "Rozšířené datové vrstvy",
    dataLayersDesc:
      "Desítky tisíc infrastrukturních objektů zmapovaných globálně. Integrace satelitních snímků s detekcí změn a SAR.",
    connectors: "100+ datových konektorů",
    connectorsDesc:
      "PostgreSQL, Snowflake, Splunk, Sentinel, Jira, Slack, Teams a další. Export do PDF, PowerPoint, CSV, GeoJSON.",
    whiteLabel: "White-label a vestavitelné řešení",
    whiteLabelDesc:
      "Vaše značka, vaše doména, vaše desktopová aplikace. Vestavitelné iframe panely pro SOC stěny a obchodní sály.",
    financial: "Finanční zpravodajství",
    financialDesc:
      "Kalendář výsledků, data o energetické síti, rozšířené sledování komodit s odvozením nákladu, screening sankcí s AIS korelací.",
    commodity: "Obchodování s komoditami",
    commodityDesc:
      "Sledování plavidel + odvození nákladu + graf dodavatelského řetězce. Vědět dříve, než se trh pohne.",
    government: "Vláda a instituce",
    governmentDesc:
      "Air-gapped, AI agenti, plný situační přehled, MCP. Žádná data neopustí vaši síť.",
    risk: "Rizikové poradenství",
    riskDesc:
      "Simulace scénářů, investorské persony, brandované PDF/PowerPoint reporty na vyžádání.",
    soc: "SOC a CERT",
    socDesc:
      "Vrstva kybernetických hrozeb, integrace SIEM, monitoring BGP anomálií, ransomware feedy.",
  ...
  m = {
    ...
    shareHint:
      "Sdílejte svůj odkaz a posuňte se v pořadníku. Každý přítel, který se připojí, vás posune blíže na začátek.",
    copied: "Zkopírováno!",
    ...
    telegram: "Telegram",
    shareText:
      "Právě jsem se zapsal do pořadníku World Monitor Pro — globální zpravodajství v reálném čase poháněné AI. Přidejte se:",
