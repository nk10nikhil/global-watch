const e = {
  ...
  r = {
    ...
    signalWord: "시그널",
    valueProps:
      "AI 기반 주식 리서치, 지정학 분석, 매크로 인텔리전스 — 실시간 상관 분석.",
  ...
  t = {
    ...
    description:
      "3D WebGL 지구본 · 45개 이상의 인터랙티브 맵 레이어 · 실시간 지정학, 시장, 에너지 및 인프라 데이터",
  },
  a = {
    ...
    quote:
      "뉴스를 분석하는 일이 정말 어려워졌습니다. 이란, 트럼프의 결정, 금융 시장, 핵심 광물, 모든 방향에서 동시에 긴장이 고조되고 있었습니다. 이런 사건들이 실시간으로 어떻게 연결되는지 보여주는 도구가 필요했습니다.",
    ceo: "CEO,",
    asToldTo: "인터뷰:",
  },
  s = {
    ...
    subtitle:
      "22개 서비스 도메인을 동시에 수집합니다. 모든 데이터를 정규화, 지오코딩하여 수천 개의 마커와 함께 WebGL 지구본에 렌더링합니다.",
    geopolitical: "지정학적 이벤트",
    geopoliticalDesc:
      "ACLED 및 UCDP 이벤트, 에스컬레이션 스코어링 및 트렌드 분석 포함",
    aviation: "항공 추적",
  ...
  n = {
    ...
    subtitle:
      "무료 대시보드는 세계를 보여줍니다. Pro는 그것이 무엇을 의미하는지 알려주고 — 중요한 것을 놓치지 않게 합니다.",
    nearRealTime: "근실시간 데이터",
    nearRealTimeDesc:
      "새로고침이 5-15분에서 60초 이내로 단축됩니다. 알림 전용 우선 파이프라인.",
    soWhat: '"그래서 뭐?" 분석',
    soWhatDesc: "영향 체인, 패턴 인식, 수렴 감지, 시장-지정학 상관관계 분석.",
    orbitalSurveillance: "궤도 감시 분석",
    orbitalSurveillanceDesc:
      "상공 통과 예측, 재방문 빈도 분석, 촬영 시간대 알림. 정찰 위성이 관심 지역을 감시하는 시점을 파악하세요.",
    morningBriefs: "모닝 브리프 및 긴급 알림",
    morningBriefsDesc:
      "AI가 야간 동향을 관심 분야별로 정리합니다. 속보 이벤트는 실시간으로 푸시됩니다.",
    alerting: "맞춤형 알림",
    alertingDesc:
      "CII 변동, 수렴 이벤트, 저장된 위치 근접성, 시장 상관관계 트리거에 대한 규칙을 설정하세요.",
    oneKey: "22개 서비스, 키 1개",
    oneKeyDesc:
      "ACLED, UCDP, Finnhub, FRED, NASA FIRMS, AISStream, OpenSky 등 — 모두 활성화, 별도 등록 불필요.",
  ...
  l = {
    ...
    critical: "긴급",
    criticalText:
      "발트해 3개 구역에서 GPS 재밍. 패턴이 이전 인프라 교란 시그니처와 일치합니다. NordBalt 케이블 + Balticconnector가 영향 구역 내에 있습니다.",
    elevated: "경계",
    elevatedText:
      "파키스탄 CII 67→74. 12건의 새로운 시위 이벤트 (라호르, 카라치, 이슬라마바드). 마지막 유사한 급등은 2024년 정치 위기에 선행했습니다.",
    watch: "주시",
    watchText:
      "브렌트유 +2.3%, 호르무즈 해협 AIS 이상 감지. 6시간 내 암선 4척. IRGC가 다음 주 훈련을 발표했습니다.",
  },
  c = {
    apiTier: "API 티어",
    title: "프로그래밍 가능한 인텔리전스",
    subtitle:
      "World Monitor 데이터를 기반으로 구축하는 개발자, 애널리스트, 팀을 위해. Pro와 독립적 — 함께 또는 별도로 사용 가능.",
    ...
    feedData:
      "대시보드에 데이터를 연결하고, Zapier/n8n/Make로 알림을 자동화하고, CII/리스크 데이터로 맞춤 스코어링 모델을 구축하세요.",
  },
  d = {
    enterpriseTier: "엔터프라이즈 티어",
    title: "인텔리전스 인프라",
    subtitle:
      "최고 수준의 보안, AI 에이전트, 데이터 심층 분석이 필요한 정부, 기관, 트레이딩 데스크, 조직을 위한 완전한 플랫폼.",
    security: "정부급 보안",
    securityDesc:
      "에어갭 배포, 온프레미스 Docker, 전용 클라우드 테넌트, SOC 2 Type II 경로, SSO/MFA, 완전한 감사 추적.",
    aiAgents: "AI 에이전트 및 MCP",
    aiAgentsDesc:
      "투자자 페르소나를 갖춘 자율 인텔리전스 에이전트. MCP를 통해 World Monitor를 Claude, GPT 또는 맞춤 LLM의 도구로 연결.",
    dataLayers: "확장 데이터 레이어",
    dataLayersDesc:
      "수만 개의 인프라 자산이 글로벌하게 매핑됩니다. 변화 감지 및 SAR이 포함된 위성 이미지 통합.",
    connectors: "100개 이상의 데이터 커넥터",
    connectorsDesc:
      "PostgreSQL, Snowflake, Splunk, Sentinel, Jira, Slack, Teams 등. PDF, PowerPoint, CSV, GeoJSON으로 내보내기.",
    whiteLabel: "화이트 라벨 및 임베드 가능",
    whiteLabelDesc:
      "귀사의 브랜드, 도메인, 데스크톱 앱. SOC 월 및 트레이딩 플로어를 위한 임베드 가능한 iframe 패널.",
    financial: "금융 인텔리전스",
    financialDesc:
      "실적 캘린더, 에너지 그리드 데이터, 화물 추정이 포함된 강화된 원자재 추적, AIS 상관관계를 통한 제재 스크리닝.",
    commodity: "원자재 거래",
    commodityDesc:
      "선박 추적 + 화물 추정 + 공급망 그래프. 시장이 움직이기 전에 파악하세요.",
    government: "정부 및 기관",
    governmentDesc:
      "에어갭, AI 에이전트, 완전한 상황 인식, MCP. 데이터가 네트워크를 벗어나지 않습니다.",
    risk: "리스크 컨설팅",
    riskDesc:
      "시나리오 시뮬레이션, 투자자 페르소나, 주문형 브랜드 PDF/PowerPoint 보고서.",
    soc: "SOCs 및 CERT",
  ...
  P = {
    ...
    shareHint:
      "링크를 공유하면 순위가 올라갑니다. 친구가 가입할 때마다 앞으로 이동합니다.",
    copied: "복사됨!",
    shareOnX: "X에서 공유",
    linkedin: "LinkedIn",
    whatsapp: "WhatsApp",
    telegram: "Telegram",
    shareText:
      "World Monitor Pro 대기 목록에 등록했습니다 — AI 기반 실시간 글로벌 인텔리전스. 함께하세요:",
