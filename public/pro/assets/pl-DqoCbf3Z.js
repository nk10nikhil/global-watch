const e = {
  ...
  a = {
    ...
    signalWord: "Sygnał",
    valueProps:
      "Analiza akcji wspierana przez AI, analiza geopolityczna i wywiad makroekonomiczny — korelowane w czasie rzeczywistym.",
  ...
  o = {
    ...
    description:
      "Glob 3D WebGL · 45+ interaktywnych warstw mapy · Dane geopolityczne, rynkowe, energetyczne i infrastrukturalne w czasie rzeczywistym",
  },
  n = {
    ...
    quote:
      "Wiadomości stały się naprawdę trudne do ogarnięcia. Iran, decyzje Trumpa, rynki finansowe, surowce krytyczne, napięcia narastające ze wszystkich stron jednocześnie. Potrzebowałem czegoś, co pokaże mi, jak te wydarzenia łączą się ze sobą w czasie rzeczywistym.",
    ceo: "CEO",
  ...
  r = {
    ...
    subtitle:
      "22 domeny usługowe przetwarzane jednocześnie. Wszystko znormalizowane, geolokalizowane i renderowane na globie WebGL z tysiącami znaczników.",
    geopolitical: "Zdarzenia geopolityczne",
    geopoliticalDesc:
      "Zdarzenia ACLED i UCDP z oceną eskalacji i analizą trendów",
    aviation: "Śledzenie lotnictwa",
    aviationDesc: "Śledzenie transponderów ADS-B globalnych wzorców lotów",
    maritime: "Żegluga i AIS",
    maritimeDesc:
      "Ruchy statków, wykrywanie jednostek, aktywność portowa i handlowa",
    fire: "Satelitarne wykrywanie pożarów",
    fireDesc:
      "Dane NASA FIRMS o pożarach i gorących punktach w czasie zbliżonym do rzeczywistego",
    ...
    gdeltDesc:
      "435+ kanałów RSS, zdarzenia GDELT oceniane przez AI, transmisje na żywo",
    ...
    seismologyDesc:
      "Trzęsienia ziemi USGS, aktywność wulkaniczna, ekstremalne zjawiska pogodowe",
  },
  t = {
    free: "Bezpłatny",
  ...
  s = {
    ...
    subtitle:
      "Darmowy pulpit pokazuje ci świat. Pro mówi ci, co to oznacza — i pilnuje, żebyś nigdy nie przegapił tego, co ważne.",
    nearRealTime: "Dane w czasie zbliżonym do rzeczywistego",
    nearRealTimeDesc:
      "Odświeżanie przyspieszone z 5-15 min do poniżej 60 sekund. Priorytetowy pipeline dla twoich alertów.",
    soWhat: 'Analiza „I co z tego?"',
    soWhatDesc:
      "Łańcuchy wpływu, rozpoznawanie wzorców, wykrywanie konwergencji i korelacja rynkowo-geopolityczna.",
    orbitalSurveillance: "Analiza nadzoru orbitalnego",
    orbitalSurveillanceDesc:
      "Prognozy przelotów, analiza częstotliwości rewizyt i alerty okien obrazowania. Wiedz, kiedy satelity wywiadowcze obserwują Twoje obszary zainteresowań.",
    morningBriefs: "Poranne briefy i alerty błyskawiczne",
    morningBriefsDesc:
      "Nocne wydarzenia zsyntetyzowane przez AI, uszeregowane według twoich obszarów zainteresowań. Zdarzenia krytyczne wysyłane w czasie rzeczywistym.",
    alerting: "Konfigurowalne alerty",
    alertingDesc:
      "Ustaw reguły dla delt CII, zdarzeń konwergencji, bliskości zapisanych lokalizacji i wyzwalaczy korelacji rynkowych.",
    oneKey: "22 usługi, 1 klucz",
    oneKeyDesc:
      "ACLED, UCDP, Finnhub, FRED, NASA FIRMS, AISStream, OpenSky i więcej — wszystko aktywne, bez osobnych rejestracji.",
  ...
  c = {
    ...
    critical: "Krytyczny",
    criticalText:
      "Zagłuszanie GPS w 3 strefach bałtyckich. Wzorzec pasuje do wcześniejszych sygnatur zakłóceń infrastruktury. Kabel NordBalt + Balticconnector w dotkniętym obszarze.",
    elevated: "Podwyższony",
    elevatedText:
      "Pakistan CII 67→74. 12 nowych zdarzeń protestowych (Lahore, Karachi, Islamabad). Ostatni porównywalny skok poprzedził kryzys polityczny 2024.",
    watch: "Obserwacja",
    watchText:
      "Brent +2,3% na anomalii AIS w Hormuz. 4 ciemne statki w 6 godz. Ćwiczenia IRGC ogłoszone na przyszły tydzień.",
  },
  y = {
    apiTier: "API TIER",
    title: "Wywiad programistyczny",
    subtitle:
      "Dla deweloperów, analityków i zespołów budujących na danych World Monitor. Oddzielnie od Pro — używaj obu lub jednego.",
    restApi: "REST API we wszystkich 22 domenach usługowych",
    authenticated: "Uwierzytelnianie per klucz, limit zapytań per tier",
    structured:
      "Ustrukturyzowany JSON z nagłówkami cache i dokumentacją OpenAPI 3.1",
    starter: "Starter",
    ...
    feedData:
      "Zasilaj dane do swoich pulpitów, automatyzuj alerty przez Zapier/n8n/Make, buduj własne modele scoringowe na danych CII/ryzyka.",
  },
  z = {
    enterpriseTier: "ENTERPRISE TIER",
    title: "Infrastruktura wywiadowcza",
    subtitle:
      "Dla rządów, instytucji, desków tradingowych i organizacji potrzebujących pełnej platformy z maksymalnym bezpieczeństwem, agentami AI i głębią danych.",
    security: "Bezpieczeństwo klasy rządowej",
    securityDesc:
      "Wdrożenie air-gapped, Docker on-premises, dedykowany tenant chmurowy, ścieżka SOC 2 Type II, SSO/MFA i pełny dziennik audytowy.",
    aiAgents: "Agenty AI i MCP",
    aiAgentsDesc:
      "Autonomiczne agenty wywiadowcze z profilami inwestorów. Podłącz World Monitor jako narzędzie do Claude, GPT lub własnych LLMs przez MCP.",
    dataLayers: "Rozszerzone warstwy danych",
    dataLayersDesc:
      "Dziesiątki tysięcy zasobów infrastrukturalnych zmapowanych globalnie. Integracja obrazów satelitarnych z wykrywaniem zmian i SAR.",
    connectors: "100+ konektorów danych",
    connectorsDesc:
      "PostgreSQL, Snowflake, Splunk, Sentinel, Jira, Slack, Teams i więcej. Eksport do PDF, PowerPoint, CSV, GeoJSON.",
    whiteLabel: "White-label i embedowalny",
    whiteLabelDesc:
      "Twoja marka, twoja domena, twoja aplikacja desktopowa. Embedowalne panele iframe do ścian SOC i sal tradingowych.",
    financial: "Wywiad finansowy",
    financialDesc:
      "Kalendarz wyników, dane sieci energetycznych, zaawansowane śledzenie surowców z inferencją ładunków, screening sankcji z korelacją AIS.",
    commodity: "Handel surowcami",
    commodityDesc:
      "Śledzenie statków + inferencja ładunków + graf łańcucha dostaw. Wiedz, zanim rynek się ruszy.",
    government: "Rządy i instytucje",
    governmentDesc:
      "Air-gapped, agenty AI, pełna świadomość sytuacyjna, MCP. Żadne dane nie opuszczają twojej sieci.",
    risk: "Firmy doradztwa ryzyka",
    riskDesc:
      "Symulacja scenariuszy, profile inwestorów, brandowane raporty PDF/PowerPoint na żądanie.",
    soc: "SOCs i CERT",
    socDesc:
      "Warstwa zagrożeń cybernetycznych, integracja SIEM, monitoring anomalii BGP, kanały ransomware.",
  ...
  k = {
    ...
    shareHint:
      "Udostępnij swój link, aby awansować w kolejce. Każdy znajomy, który dołączy, przesuwa cię bliżej początku.",
    copied: "Skopiowano!",
    ...
    telegram: "Telegram",
    shareText:
      "Właśnie dołączyłem do listy oczekujących World Monitor Pro — globalny wywiad w czasie rzeczywistym napędzany przez AI. Dołącz:",
