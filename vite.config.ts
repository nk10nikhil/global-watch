  ...
  return {
    ...
    transformIndexHtml(html) {
      let result = html
        ...
        .replace(/"name": "Global Watch"/, `"name": "${activeMeta.siteName}"`)
        .replace(
          /"alternateName": "GlobalWatch"/,
          `"alternateName": "${activeMeta.siteName.replace(" ", "")}"`,
        )
        .replace(
          /"url": "https:\/\/GLOBALWATCH\.app\/"/,
          `"url": "${activeMeta.url}"`,
        )
        .replace(
      ...
      if (activeVariant !== "full") {
        result = result
          ...
          .replace(
            ...
            `/favico/${activeVariant}/apple-touch-icon`,
          )
          .replace(
            /\/favico\/android-chrome/g,
            `/favico/${activeVariant}/android-chrome`,
          )
  ...
  return {
    ...
    configureServer(server) {
      server.middlewares.use(async (req, res, next) => {
        ...
        const closed = ["true", "false"].includes(
          url.searchParams.get("closed") ?? "",
        )
          ? url.searchParams.get("closed")
          : "false";
        const order = ALLOWED_ORDER.includes(
          url.searchParams.get("order") ?? "",
        )
          ? url.searchParams.get("order")
          : "volume";
        const ascending = ["true", "false"].includes(
...
function sebufApiPlugin(): Plugin {
  ...
  async function buildRouter() {
    const [
      ...
      tradeServerMod,
      tradeHandlerMod,
      supplyChainServerMod,
      supplyChainHandlerMod,
      naturalServerMod,
      naturalHandlerMod,
    ] = await Promise.all([
      ...
      import("./src/generated/server/globalwatch/seismology/v1/service_server"),
      import("./server/globalwatch/seismology/v1/handler"),
      import("./src/generated/server/globalwatch/wildfire/v1/service_server"),
      import("./server/globalwatch/wildfire/v1/handler"),
      import("./src/generated/server/globalwatch/climate/v1/service_server"),
      import("./server/globalwatch/climate/v1/handler"),
      import("./src/generated/server/globalwatch/prediction/v1/service_server"),
      import("./server/globalwatch/prediction/v1/handler"),
      import("./src/generated/server/globalwatch/displacement/v1/service_server"),
      import("./server/globalwatch/displacement/v1/handler"),
      import("./src/generated/server/globalwatch/aviation/v1/service_server"),
      import("./server/globalwatch/aviation/v1/handler"),
      import("./src/generated/server/globalwatch/research/v1/service_server"),
      import("./server/globalwatch/research/v1/handler"),
      import("./src/generated/server/globalwatch/unrest/v1/service_server"),
      import("./server/globalwatch/unrest/v1/handler"),
      import("./src/generated/server/globalwatch/conflict/v1/service_server"),
      import("./server/globalwatch/conflict/v1/handler"),
      import("./src/generated/server/globalwatch/maritime/v1/service_server"),
      import("./server/globalwatch/maritime/v1/handler"),
      import("./src/generated/server/globalwatch/cyber/v1/service_server"),
      import("./server/globalwatch/cyber/v1/handler"),
      import("./src/generated/server/globalwatch/economic/v1/service_server"),
      import("./server/globalwatch/economic/v1/handler"),
      import("./src/generated/server/globalwatch/infrastructure/v1/service_server"),
      import("./server/globalwatch/infrastructure/v1/handler"),
      import("./src/generated/server/globalwatch/market/v1/service_server"),
      import("./server/globalwatch/market/v1/handler"),
      import("./src/generated/server/globalwatch/news/v1/service_server"),
      import("./server/globalwatch/news/v1/handler"),
      import("./src/generated/server/globalwatch/intelligence/v1/service_server"),
      import("./server/globalwatch/intelligence/v1/handler"),
      import("./src/generated/server/globalwatch/military/v1/service_server"),
      import("./server/globalwatch/military/v1/handler"),
      import("./src/generated/server/globalwatch/positive_events/v1/service_server"),
      import("./server/globalwatch/positive-events/v1/handler"),
      import("./src/generated/server/globalwatch/giving/v1/service_server"),
      import("./server/globalwatch/giving/v1/handler"),
      import("./src/generated/server/globalwatch/trade/v1/service_server"),
      import("./server/globalwatch/trade/v1/handler"),
      import("./src/generated/server/globalwatch/supply_chain/v1/service_server"),
      import("./server/globalwatch/supply-chain/v1/handler"),
      import("./src/generated/server/globalwatch/natural/v1/service_server"),
      import("./server/globalwatch/natural/v1/handler"),
    ]);
    ...
    const allRoutes = [
      ...
      ...unrestServerMod.createUnrestServiceRoutes(
        unrestHandlerMod.unrestHandler,
        serverOptions,
      ),
      ...
      ...cyberServerMod.createCyberServiceRoutes(
        cyberHandlerMod.cyberHandler,
        serverOptions,
      ),
      ...
      ...marketServerMod.createMarketServiceRoutes(
        marketHandlerMod.marketHandler,
        serverOptions,
      ),
      ...newsServerMod.createNewsServiceRoutes(
        newsHandlerMod.newsHandler,
        serverOptions,
      ),
      ...
      ...givingServerMod.createGivingServiceRoutes(
        givingHandlerMod.givingHandler,
        serverOptions,
      ),
      ...tradeServerMod.createTradeServiceRoutes(
        tradeHandlerMod.tradeHandler,
        serverOptions,
      ),
      ...supplyChainServerMod.createSupplyChainServiceRoutes(
        supplyChainHandlerMod.supplyChainHandler,
        serverOptions,
      ),
      ...naturalServerMod.createNaturalServiceRoutes(
        naturalHandlerMod.naturalHandler,
        serverOptions,
      ),
    ];
    ...
    configureServer(server) {
      ...
      server.watcher.on("change", (file) => {
        if (
          ...
          file.includes("/src/generated/server/")
        ) {
          cachedRouter = null;
        }
      });
      ...
      server.middlewares.use(async (req, res, next) => {
        ...
        try {
          ...
          if (!matchedHandler) {
            const allowed = router.allowedMethods(
            ...
            res.end(
              JSON.stringify({
                error:
                  res.statusCode === 405 ? "Method not allowed" : "Not found",
              }),
            );
            return;
          }
  ...
  return {
    ...
    configureServer(server) {
      server.middlewares.use(async (req, res, next) => {
        ...
        try {
          const channelHandle = channel.startsWith("@")
            ? channel
            : `@${channel}`;
          ...
          res.setHeader("Cache-Control", "public, max-age=300");
          res.end(
            JSON.stringify({ videoId, isLive: videoId !== null, channel }),
          );
        } catch (error) {
      ...
      server.middlewares.use(async (req, res, next) => {
        ...
        try {
          const data = await readFile(
            resolve(__dirname, "scripts/data/gpsjam-latest.json"),
            "utf8",
          );
          res.setHeader("Content-Type", "application/json");
          ...
          res.end(
            JSON.stringify({
              error: "No GPS jam data. Run: node scripts/fetch-gpsjam.mjs",
            }),
          );
        }
      });
...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      "@loaders.gl/worker-utils/dist/lib/process-utils/child-process-proxy.js":
        resolve(__dirname, "src/shims/child-process-proxy.ts"),
    },
  },
  build: {
