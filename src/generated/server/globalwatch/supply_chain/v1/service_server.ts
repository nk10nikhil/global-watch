...
// source: globalwatch/supply_chain/v1/service.proto
  ...
  return [
    {
      ...
      handler: async (req: Request): Promise<Response> => {
        try {
          ...
          return new Response(
            JSON.stringify(result as GetShippingRatesResponse),
            {
              status: 200,
    ...
    },
    {
      ...
      handler: async (req: Request): Promise<Response> => {
        try {
          ...
          return new Response(
            JSON.stringify(result as GetChokepointStatusResponse),
            {
              status: 200,
              headers: { "Content-Type": "application/json" },
            },
    ...
    },
    {
      ...
      handler: async (req: Request): Promise<Response> => {
        try {
          ...
          return new Response(
            JSON.stringify(result as GetCriticalMineralsResponse),
            {
              status: 200,
              headers: { "Content-Type": "application/json" },
            },
