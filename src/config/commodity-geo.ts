...
export const MINING_SITES: MineSite[] = [
  // === GOLD ===
  {
    ...
    status: "producing",
    significance:
      "Largest gold mining district in Western Hemisphere. ~3.5Moz/yr combined output.",
  ...
  },
  {
    ...
    status: "producing",
    significance:
      "Australia's largest gold mine. Also significant copper by-product.",
  ...
  },
  {
    ...
    status: "producing",
    significance:
      "World's deepest gold mine (4km). High-grade underground operation.",
  ...
  },
  {
    ...
    status: "producing",
    significance:
      "Russia's largest gold mine, among world's top 5. Siberian deposit.",
  ...
  },
  {
    ...
    status: "producing",
    significance:
      "Canada's largest open-pit gold mine by land area. ~700koz/yr.",
    openPitOrUnderground: "open-pit",
  },
  {
    id: "cortez",
    ...
    status: "producing",
    significance:
      "Major Tier One gold mine in Nevada. Part of Nevada Gold Mines complex.",
    openPitOrUnderground: "both",
  },
  {
    id: "donlin-gold",
    ...
    status: "development",
    significance:
      "One of the world's largest undeveloped gold deposits. Remote Alaska site.",
    openPitOrUnderground: "open-pit",
  },
  ...
  // === SILVER ===
  {
    ...
    status: "producing",
    significance:
      "World's largest primary silver mine. >50Moz/yr silver output.",
  ...
  // === COPPER ===
  {
    ...
    status: "producing",
    significance:
      "World's largest copper mine. ~1.2Mt Cu/yr. Atacama Desert, Chile.",
  ...
  },
  {
    ...
    status: "producing",
    significance:
      "World's largest open-pit copper mine by volume. Transitioning to underground.",
  ...
  },
  {
    ...
    status: "producing",
    significance:
      "World's third-largest copper-gold deposit. Underground expansion ramping up.",
    openPitOrUnderground: "both",
  },
  {
    id: "lumwana",
    ...
    status: "producing",
    significance:
      "One of Africa's largest copper mines. ~140kt Cu/yr. Major Zambian producer.",
    openPitOrUnderground: "open-pit",
  },
  ...
  // === LITHIUM ===
  {
    ...
    status: "producing",
    significance:
      "World's largest hard-rock lithium mine. Highest-grade spodumene deposit.",
  ...
  },
  {
    ...
    status: "producing",
    significance:
      "World's largest and lowest-cost lithium brine source. ~150kt LCE/yr.",
  ...
  },
  {
    ...
    status: "producing",
    significance:
      "Key Argentina lithium brine operation. Part of the Lithium Triangle.",
    openPitOrUnderground: "in-situ",
  },
  {
    id: "cauchari-olaroz",
  ...
  },
  {
    ...
    status: "producing",
    significance:
      "Only active US lithium mine. Nevada brine operation since 1966.",
    openPitOrUnderground: "in-situ",
  },
  {
    id: "thacker-pass",
    ...
    status: "development",
    significance:
      "Largest known lithium deposit in the US. Under development in Nevada.",
    openPitOrUnderground: "open-pit",
  },
  {
    id: "manono",
    ...
    status: "development",
    significance:
      "World's largest hard-rock lithium deposit. DRC asset under development.",
    openPitOrUnderground: "open-pit",
  },
  ...
  // === COBALT ===
  {
    ...
    status: "producing",
    significance:
      "World's largest cobalt mine. ~25kt Co/yr when at full capacity.",
  ...
  },
  {
    ...
    status: "producing",
    significance:
      "Highest-grade rare earth deposit outside China. Key non-Chinese REE source.",
  ...
  },
  {
    ...
    status: "producing",
    significance:
      "World's largest palladium mine and top nickel producer. Arctic Siberian site.",
  ...
  },
  {
    ...
    status: "producing",
    significance:
      "High-grade nickel-cobalt-copper mine in Labrador. Strategic Canadian deposit.",
    openPitOrUnderground: "underground",
  },
  {
    id: "goro",
    ...
    status: "producing",
    significance:
      "Major laterite nickel operation. Battery-grade nickel and cobalt production.",
    openPitOrUnderground: "open-pit",
  },
  {
    id: "taganito",
    ...
    status: "producing",
    significance:
      "Key Philippine nickel laterite mine. Major Japanese nickel supply source.",
    openPitOrUnderground: "open-pit",
  },
  ...
  // === PLATINUM / PALLADIUM ===
  {
    ...
    status: "producing",
    significance:
      "World's largest open-pit platinum mine. Bushveld Igneous Complex.",
  ...
  },
  {
    ...
    status: "producing",
    significance:
      "Zimbabwe's largest mining company. World's third-largest PGM producer.",
    openPitOrUnderground: "both",
  },
  {
    id: "stillwater",
    ...
    status: "producing",
    significance:
      "Only significant PGM mine in North America. Primary US palladium source.",
  ...
  // === IRON ORE ===
  {
    ...
    status: "producing",
    significance:
      "BHP's Pilbara hub — world's most productive iron ore mining region. ~280Mt/yr.",
  ...
  },
  {
    ...
    status: "producing",
    significance:
      "Rio Tinto's Pilbara operations — 16 mines feeding 4 port facilities. ~330Mt/yr.",
  ...
  },
  {
    ...
    status: "producing",
    significance:
      "World's largest high-grade uranium deposit currently in production.",
  ...
  },
  {
    ...
    status: "producing",
    significance:
      "World's largest known uranium ore body. Also produces copper, gold, silver.",
  ...
  },
  {
    ...
    status: "producing",
    significance:
      "One of the world's largest open-pit uranium mines. Chinese-owned since 2019.",
    openPitOrUnderground: "open-pit",
  },
  {
    id: "husab",
    ...
    status: "producing",
    significance:
      "Second-largest uranium mine globally by production. 100% Chinese-owned.",
...
export const PROCESSING_PLANTS: ProcessingPlant[] = [
  // Rare Earth Processing
  {
    ...
    status: "operating",
    significance:
      "World's largest rare earth processing hub. Processes ore from Bayan Obo.",
  ...
  },
  {
    ...
    status: "operating",
    significance:
      "Largest rare earth processing facility outside China. Processes Mt Weld ore.",
  ...
  },
  {
    ...
    status: "operating",
    significance:
      "US rare earth concentrate processing. Building downstream magnet manufacturing.",
  },
  // Lithium Processing
  {
    id: "ganzhou-lithium",
  ...
  },
  {
    ...
    status: "operating",
    significance:
      "Europe's largest copper smelter. Major recycled copper processor.",
...
export const COMMODITY_PORTS: CommodityPort[] = [
  ...
  },
  {
    ...
    significance:
      "Rio Tinto's primary iron ore export terminal. Part of Pilbara port network.",
  },
  {
    id: "punta-patache",
  ...
  },
  {
    ...
    significance:
      "Brazil's largest port. Key iron ore and agricultural export terminal.",
  },
  {
    id: "richards-bay",
  ...
  },
  {
    ...
    significance:
      "Primary export gateway for DRC and Zambia cobalt and copper.",
  },
  {
    id: "walvis-bay",
    name: "Walvis Bay",
    ...
    significance:
      "Primary export port for Namibian uranium from Rössing and Husab mines.",
  },
  {
    id: "tema-ghana",
    name: "Tema Port",
    ...
    significance:
      "Primary gold export gateway for Ghana, one of Africa's largest gold producers.",
  },
  {
    id: "callao-peru",
    name: "Port of Callao",
