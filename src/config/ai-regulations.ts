...
export const AI_REGULATIONS: AIRegulation[] = [
  ...
  },
  {
    ...
    description:
      "Non-binding framework for protecting civil rights in the age of AI.",
  },
  ...
  // China
  {
    ...
    description:
      "Regulations governing algorithmic recommendation services and content.",
  },
  {
    id: "cn-generative-ai",
    ...
    link: "http://www.cac.gov.cn/",
    description:
      "First national regulation specifically targeting generative AI services.",
  },
  ...
  // Singapore
  {
    ...
    description:
      "Voluntary framework providing guidance on responsible AI deployment.",
  },
  ...
  // Brazil
  {
    ...
    description:
      "Proposed comprehensive AI law (Bill 2338/2023). Under legislative review.",
  },
  ...
  // Japan
  {
    ...
    description:
      "Non-binding guidelines focusing on fostering AI innovation while managing risks.",
  },
  ...
  // South Korea
  {
    ...
    description:
      "Voluntary framework emphasizing ethical AI development and deployment.",
  },
];
...
export const REGULATORY_ACTIONS: RegulatoryAction[] = [
  ...
  },
  {
    ...
    type: "guideline",
    description:
      "NIST published updated AI Risk Management Framework with enhanced guidance.",
    impact: "medium",
    source: "NIST",
  },
  {
    ...
    description:
      "Executive order to streamline permitting for AI datacenter construction.",
    impact: "high",
    source: "White House",
  },
  {
    ...
    type: "guideline",
    description:
      "28 countries signed declaration on AI safety cooperation and frontier AI risks.",
    impact: "high",
  ...
  },
  {
    ...
    description:
      "President Biden signed comprehensive executive order on AI safety and security.",
    impact: "high",
    source: "White House",
  },
  {
    ...
    description:
      "China's measures for managing generative AI services became enforceable.",
    impact: "high",
    source: "CAC",
  },
  {
    ...
    regulationId: "eu-ai-act",
    description:
      "EU expected to begin enforcement actions for non-compliant AI systems.",
    impact: "high",
    source: "European Commission",
  },
];
...
export const COUNTRY_REGULATION_PROFILES: CountryRegulationProfile[] = [
  ...
  },
  {
    ...
    lastUpdated: "2024-08-01",
    summary:
      "Comprehensive risk-based regulation. World's strictest AI governance framework.",
  },
  {
    country: "United Kingdom",
    countryCode: "GB",
    ...
    summary:
      "Pro-innovation, principles-based approach. Light-touch regulation.",
  },
  {
    country: "China",
    countryCode: "CN",
    ...
    summary:
      "Content-focused regulation aligned with state values. Registration requirements.",
  },
  {
    country: "Canada",
    countryCode: "CA",
    ...
    summary:
      "Comprehensive law in development. Risk-based approach similar to EU.",
  },
  {
    country: "Singapore",
    countryCode: "SG",
    ...
    summary:
      "Voluntary governance framework. Pro-business, innovation-friendly approach.",
  },
  {
    country: "Japan",
    countryCode: "JP",
    ...
    summary:
      "Non-binding guidelines. Focus on international cooperation and innovation.",
  },
  {
    country: "South Korea",
    countryCode: "KR",
  ...
  },
  {
    ...
    summary:
      "No comprehensive AI regulation yet. Sectoral approaches under development.",
  },
  {
    country: "Australia",
    countryCode: "AU",
    ...
    lastUpdated: "2023-06-01",
    summary:
      "Voluntary AI Ethics Framework. Mandatory guardrails under consideration.",
  },
];
...
export function getCountryProfile(
  countryCode: string,
): CountryRegulationProfile | undefined {
  return COUNTRY_REGULATION_PROFILES.find(
    (profile) => profile.countryCode === countryCode,
  );
}
...
export function getUpcomingDeadlines(): AIRegulation[] {
  ...
  return AI_REGULATIONS.filter((reg) => {
    ...
    return (
      new Date(a.complianceDeadline!).getTime() -
      new Date(b.complianceDeadline!).getTime()
    );
  });
}
...
export function getRecentActions(months: number = 6): RegulatoryAction[] {
  ...
  return REGULATORY_ACTIONS.filter(
    (action) => new Date(action.date) >= cutoffDate,
