...
// VITE_VARIANT=tech → globalwatchtech.vercel.app (tech-focused)
// VITE_VARIANT=full → myglobalwatch.vercel.app (geopolitical)
// VITE_VARIANT=finance → globalwatchfinance.vercel.app (markets/trading)
