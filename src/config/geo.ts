...
export const INTEL_HOTSPOTS: Hotspot[] = [
  ...
  },
  {
    ...
    history: {
      ...
      cyclicalRisk:
        "Election cycles trigger violence; cartel leadership changes spark turf wars",
    },
    whyItMatters:
...
export const CONFLICT_ZONES: ConflictZone[] = [
  ...
  },
  {
    ...
    location:
      "Pakistan–Afghanistan border (KPK, Balochistan, Federally Administered Tribal Areas)",
    description:
