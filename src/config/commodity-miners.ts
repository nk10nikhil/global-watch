...
export const COMMODITY_MINERS: CommodityMiner[] = [
  ...
  },
  {
    ...
    stockSymbol: "RIO",
    description:
      "Anglo-Australian mining giant. World's second-largest iron ore producer.",
    employees: 55000,
    marketCapUSD: 100,
  },
  {
  ...
  // ============================================================
  {
    ...
    stockSymbol: "NEM",
    description:
      "World's largest gold mining company by production. Operations on 6 continents.",
    employees: 38000,
    marketCapUSD: 35,
  },
  {
  ...
  },
  {
    ...
    stockSymbol: "AEM",
    description:
      "Senior gold producer with operations in Canada, Finland, Mexico, and Australia.",
    employees: 15000,
    marketCapUSD: 35,
  },
  {
    ...
    stockSymbol: "GFI",
    description:
      "South African gold major with assets in SA, Ghana, Australia, Peru, and Chile.",
    employees: 25000,
    marketCapUSD: 15,
  },
  {
    ...
    stockSymbol: "AU",
    description:
      "Third-largest gold producer. Operations across Africa, Americas, and Australia.",
    employees: 30000,
    marketCapUSD: 12,
  },
  {
  ...
  },
  {
    ...
    stockSymbol: "FRES.L",
    description:
      "World's largest primary silver producer. Operating in Mexico since 1554.",
    employees: 12000,
    marketCapUSD: 6,
  },
  {
    ...
    stockSymbol: "PAAS",
    description:
      "Leading primary silver mining company with operations across Latin America.",
    employees: 14000,
    marketCapUSD: 5,
  },
  ...
  },
  {
    ...
    stockSymbol: "SQM",
    description:
      "World's second-largest lithium producer. Primary operator at Salar de Atacama.",
    employees: 5400,
    marketCapUSD: 12,
  },
  {
    ...
    stockSymbol: "PLS.AX",
    description:
      "Pure-play lithium miner operating Pilgangoora in Western Australia.",
    employees: 900,
    marketCapUSD: 3,
  },
  {
  ...
  },
  {
    ...
    stockSymbol: "SCCO",
    description:
      "Largest copper reserves globally. Major operations in Mexico and Peru.",
    employees: 14000,
    marketCapUSD: 60,
  },
  {
  ...
  },
  {
    ...
    stockSymbol: "WPM",
    description:
      "World's largest precious metals streaming company. Agreements on 40+ mines.",
    employees: 50,
    marketCapUSD: 22,
  },
  {
