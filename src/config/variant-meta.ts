...
export const VARIANT_META: { full: VariantMeta; [k: string]: VariantMeta } = {
  full: {
    title: "Global Watch - Real-Time Global Intelligence Dashboard",
    description:
    ...
    url: "https://myglobalwatch.vercel.app/",
    siteName: "Global Watch",
    shortName: "Global Watch",
  ...
  tech: {
    ...
    url: "https://globalwatchtech.vercel.app/",
  ...
  happy: {
    ...
    url: "https://globalwatchhappy.vercel.app/",
  ...
  finance: {
    ...
    url: "https://globalwatchfinance.vercel.app/",
  ...
  commodity: {
    title:
      "Commodity Monitor - Real-Time Commodity Markets & Supply Chain Dashboard",
    description:
