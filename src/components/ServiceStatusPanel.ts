...
export class ServiceStatusPanel extends Panel {
  ...
  public async fetchStatus(): Promise<boolean> {
    try {
      ...
      const fingerprint = data.services
  ...
  protected render(): void {
    ...
    replaceChildren(
      ...
      issues.length === 0
        ? h(
            "div",
            { className: "all-operational" },
            t("components.serviceStatus.allOperational"),
          )
        : false,
    );
  }
    ...
    return h(
      ...
      h(
        ...
        h(
          "span",
          { className: "summary-label" },
          t("components.serviceStatus.degraded"),
        ),
      ),
      h(
        "div",
        ...
        h(
          "span",
          { className: "summary-label" },
          t("components.serviceStatus.outage"),
        ),
      ),
    );
  }
