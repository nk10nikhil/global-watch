...
import { EconomicServiceClient } from "@/generated/client/globalwatch/economic/v1/service_client";
import type { GetMacroSignalsResponse } from "@/generated/client/globalwatch/economic/v1/service_client";
...
export class MacroSignalsPanel extends Panel {
  ...
  public async fetchData(): Promise<boolean> {
    const hydrated = getHydratedData("macroSignals") as
