...
export class DeductionPanel extends Panel {
  ...
  constructor(getLatestNews?: () => NewsItem[]) {
    ...
    this.inputEl = h("textarea", {
      ...
      placeholder:
        "E.g., What will possibly happen in the next 24 hours in Middle East?",
      required: true,
      rows: 3,
  ...
  private async handleSubmit(e: Event) {
    ...
    try {
      ...
      if (resp.analysis) {
        ...
        const meta = h(
          "div",
          { style: "margin-top: 12px; font-size: 0.75em; color: #888;" },
      ...
      this.resultContainer.textContent =
        "An error occurred while analyzing the situation.";
    } finally {
