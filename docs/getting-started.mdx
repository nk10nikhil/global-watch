...
description: "Installation instructions, tech stack overview, project structure, API dependencies, and setup guide for GlobalWatch."
---

This guide covers everything you need to set up GlobalWatch locally, from prerequisites and installation to understanding the project structure and API dependencies.
...
> Matthias Schafer, Martin Strohmeier, Vincent Lenders, Ivan Martinovic and Matthias Wilhelm. "Bringing Up OpenSky: A Large-scale ADS-B Sensor Network for Research". In _Proceedings of the 13th IEEE/ACM International Symposium on Information Processing in Sensor Networks (IPSN)_, pages 83-94, April 2014.
...
Global Watch is licensed under the [GNU Affero General Public License v3.0 (AGPL-3.0)](/license) for non-commercial use. Commercial use requires a [separate license](/license#commercial-use-requires-a-separate-license). See the [License](/license) page for full details on what this means in practice.
