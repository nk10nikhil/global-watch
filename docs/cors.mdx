...
| Pattern                                     | Matches                                             |
| ------------------------------------------- | --------------------------------------------------- |
| `(*.)?myglobalwatch.vercel.app`                     | Production + subdomains (`tech.`, `finance.`, etc.) |
| `GLOBALWATCH-*-elie-*.vercel.app`          | Vercel preview deploys                              |
...
- `Content-Type`
- `Authorization`
- `X-GlobalWatch-Key` (API key for desktop/third-party access). See [API Key Gating](/api-key-deployment) for key management details.
