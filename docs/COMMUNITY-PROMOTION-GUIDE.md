# Global Watch — Community Promotion Guide

Thank you for helping spread the word about Global Watch! This guide provides talking points, must-see features, and visual suggestions to help you create compelling content for your audience.
...
**Longer description**: Global Watch aggregates 170+ news feeds, military tracking, financial markets, conflict data, protest monitoring, satellite imagery, and AI-powered analysis into a single unified dashboard with an interactive globe. Available as a web app, desktop app (macOS/Windows/Linux), and installable PWA.
...
| Link                                                         | Description                                         |
| ------------------------------------------------------------ | --------------------------------------------------- |
| [myglobalwatch.vercel.app](https://myglobalwatch.vercel.app)                 | Main dashboard — geopolitics, military, conflicts   |
| [globalwatchtech.vercel.app](https://globalwatchtech.vercel.app)       | Tech variant — startups, AI/ML, cybersecurity       |
| [globalwatchfinance.vercel.app](https://globalwatchfinance.vercel.app) | Finance variant — markets, exchanges, central banks |
| [GitHub](https://github.com/nk10nikhil/globalwatch)            | Source code (AGPL-3.0)                              |
...
- **Name**: "Global Watch" (two words, capitalized)
- **Tagline**: "Real-time global intelligence dashboard"
- **License**: AGPL-3.0 (free and open source)
- **Creator**: Credit "Global Watch by Elie Habib" or link to the GitHub repo
...
We genuinely appreciate community members helping grow Global Watch's reach. Feel free to interpret these guidelines creatively — there's no strict template. The most compelling content comes from showing what YOU find most interesting or useful about the tool.
