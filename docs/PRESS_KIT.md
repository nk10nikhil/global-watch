...
Global Watch runs five thematic variants from a single codebase, each tailored to a different audience:

| Variant               | Domain                     | Focus                                            |
| --------------------- | -------------------------- | ------------------------------------------------ |
| **Global Watch**     | myglobalwatch.vercel.app           | Geopolitics, military, conflicts, infrastructure |
| **Tech Monitor**      | globalwatchtech.vercel.app      | AI/ML, startups, cybersecurity, tech ecosystems  |
| **Finance Monitor**   | globalwatchfinance.vercel.app   | Markets, central banks, Gulf FDI, commodities    |
| **Commodity Monitor** | globalwatchcommodity.vercel.app | Mining, metals, energy, critical minerals        |
| **Happy Monitor**     | globalwatchhappy.vercel.app     | Good news, conservation, positive global trends  |

### AI Intelligence Layer

Global Watch uses a multi-tier AI pipeline to process and summarize information:
...
Global Watch aggregates publicly available data from dozens of sources. No proprietary or classified information is used. Key source categories:
...
Global Watch serves several audiences:
...
| Feature                     | Global Watch               | Traditional OSINT Tools | News Aggregators |
| --------------------------- | --------------------------- | ----------------------- | ---------------- |
...
- **Web**: Available at myglobalwatch.vercel.app and variant subdomains
...
Global Watch is actively developed with planned expansions across several areas:
...
- **API access** for developers and organizations to integrate Global Watch data into their own tools
...
**Q: Where does Global Watch get its data?**
...
**Q: Does Global Watch track users or sell data?**
...
A: Yes. Global Watch is licensed under AGPL-3.0, meaning anyone can inspect, audit, modify, and redistribute the code. If you run a modified version as a service, you must share your modifications under the same license.

**Q: Who built this?**
A: Global Watch was created by Elie Habib. It is an independent project, not affiliated with any government, intelligence agency, or defense contractor.

**Q: Can I embed Global Watch or use its data in my reporting?**
A: The web interface can be referenced and linked in reporting. For data integration, an API tier is planned. Please attribute "Global Watch (myglobalwatch.vercel.app)" when referencing the platform in published work.

**Q: How is this different from Janes, Palantir, or Dataminr?**
A: Those are enterprise products costing tens to hundreds of thousands of dollars per year, typically sold to governments and large corporations. Global Watch aims to democratize access to situational awareness by aggregating public data and using AI to make it digestible. It is open source, free to use, and designed for individual analysts and small teams, not just large organizations.
...
A: Global Watch is primarily a solo project by its creator, with occasional open-source contributions from the community.
...
- **GitHub**: github.com/nk10nikhil/globalwatch
- **Website**: myglobalwatch.vercel.app

---

_This document was last updated March 2026. Global Watch is an independent, open-source project licensed under AGPL-3.0._
