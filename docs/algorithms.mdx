...
description: "Detailed documentation of Global Watch's scoring formulas, detection algorithms, and classification pipelines."
---
...
Beyond aggregating signals by geography, the system detects meaningful correlations _across_ data streams — identifying patterns that no single source would reveal. 14 signal types are continuously evaluated:
