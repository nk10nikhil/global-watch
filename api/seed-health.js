...
const SEED_DOMAINS = {
  ...
  "seismology:earthquakes": {
    key: "seed-meta:seismology:earthquakes",
    intervalMin: 15,
  },
  ...
  "market:gulf-quotes": {
    key: "seed-meta:market:gulf-quotes",
    intervalMin: 15,
  },
  "market:stablecoins": {
    key: "seed-meta:market:stablecoins",
    intervalMin: 30,
  },
  ...
  "intelligence:satellites": {
    key: "seed-meta:intelligence:satellites",
    intervalMin: 90,
  },
  "military:flights": { key: "seed-meta:military:flights", intervalMin: 8 },
  "infra:service-statuses": {
    key: "seed-meta:infra:service-statuses",
    intervalMin: 60,
  },
  "supply_chain:shipping": {
    key: "seed-meta:supply_chain:shipping",
    intervalMin: 120,
  },
  "supply_chain:chokepoints": {
    key: "seed-meta:supply_chain:chokepoints",
    intervalMin: 30,
  },
  ...
  "research:tech-events": {
    key: "seed-meta:research:tech-events",
    intervalMin: 210,
  },
};
...
export default async function handler(req) {
  ...
  const overall =
    missingCount > 0 ? "degraded" : staleCount > 0 ? "warning" : "healthy";

  const httpStatus =
    overall === "healthy" ? 200 : overall === "warning" ? 200 : 503;
